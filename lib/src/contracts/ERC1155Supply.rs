...
pub mod erc1155_supply {
    ...
    pub static ERC1155SUPPLY_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(||
    ::ethers::core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid"));
    pub struct ERC1155Supply<M>(::ethers::contract::Contract<M>);
    ...
    impl<M: ::ethers::providers::Middleware> ERC1155Supply<M> {
    ...
    impl ::ethers::contract::EthLogDecode for ERC1155SupplyEvents {
        fn decode_log(
    ...
    impl ::ethers::core::abi::AbiDecode for ERC1155SupplyCalls {
        fn decode(
            data: impl AsRef<[u8]>,
            ...
            if let Ok(decoded)
                = <ExistsCall as ::ethers::core::abi::AbiDecode>::decode(data) {
    ...
    impl ::ethers::core::abi::AbiEncode for ERC1155SupplyCalls {
