...
pub mod i_fx_message_processor {
    ...
    pub static IFXMESSAGEPROCESSOR_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    > = ::ethers::contract::Lazy::new(|| {
        ::ethers::core::utils::__serde_json::from_str(__ABI)
            .expect("ABI is always valid")
    });
    pub struct IFxMessageProcessor<M>(::ethers::contract::Contract<M>);
    ...
    impl<M: ::ethers::providers::Middleware> IFxMessageProcessor<M> {
        ...
        pub fn process_message_from_root(
            &self,
            state_id: ::ethers::core::types::U256,
    ...
    pub struct ProcessMessageFromRootCall {
        pub state_id: ::ethers::core::types::U256,
