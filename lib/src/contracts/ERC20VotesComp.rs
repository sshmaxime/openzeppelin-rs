...
pub mod erc20_votes_comp {
    ...
    impl ::ethers::core::abi::AbiDecode for ERC20VotesCompErrors {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for ERC20VotesCompErrors {
    ...
    impl ::ethers::contract::ContractRevert for ERC20VotesCompErrors {
