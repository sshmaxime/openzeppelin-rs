...
pub mod erc721_pausable {
    ...
    pub static ERC721PAUSABLE_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(||
    ::ethers::core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid"));
    pub struct ERC721Pausable<M>(::ethers::contract::Contract<M>);
    ...
    impl<M: ::ethers::providers::Middleware> ERC721Pausable<M> {
    ...
    impl ::ethers::contract::EthLogDecode for ERC721PausableEvents {
        fn decode_log(
    ...
    impl ::ethers::core::abi::AbiDecode for ERC721PausableCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for ERC721PausableCalls {
