...
pub mod erc1155_preset_minter_pauser {
    ...
    pub static ERC1155PRESETMINTERPAUSER_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    ...
    pub static ERC1155PRESETMINTERPAUSER_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __BYTECODE,
    );
    #[rustfmt::skip]
    ...
    pub static ERC1155PRESETMINTERPAUSER_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    pub struct ERC1155PresetMinterPauser<M>(::ethers::contract::Contract<M>);
    ...
    impl<M: ::ethers::providers::Middleware> ERC1155PresetMinterPauser<M> {
    ...
    impl ::ethers::contract::EthLogDecode for ERC1155PresetMinterPauserEvents {
        fn decode_log(
    ...
    impl ::ethers::core::abi::AbiDecode for ERC1155PresetMinterPauserCalls {
        fn decode(
            data: impl AsRef<[u8]>,
            ...
            if let Ok(decoded)
                = <MintBatchCall as ::ethers::core::abi::AbiDecode>::decode(data) {
    ...
    impl ::ethers::core::abi::AbiEncode for ERC1155PresetMinterPauserCalls {
