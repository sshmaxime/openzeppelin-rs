...
pub mod vesting_wallet {
    ...
    pub static VESTINGWALLET_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(||
    ...
    pub static VESTINGWALLET_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __BYTECODE,
    );
    #[rustfmt::skip]
    ...
    pub static VESTINGWALLET_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    pub struct VestingWallet<M>(::ethers::contract::Contract<M>);
    ...
    impl<M: ::ethers::providers::Middleware> VestingWallet<M> {
    ...
    impl ::ethers::contract::EthLogDecode for VestingWalletEvents {
        fn decode_log(
    ...
    impl ::ethers::core::abi::AbiDecode for VestingWalletCalls {
        fn decode(
            data: impl AsRef<[u8]>,
            ...
            if let Ok(decoded)
                = <StartCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::Start(decoded));
            }
            if let Ok(decoded)
                = <VestedAmountCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::VestedAmount(decoded));
            }
            if let Ok(decoded)
                = <VestedAmountWithTokenCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
    ...
    impl ::ethers::core::abi::AbiEncode for VestingWalletCalls {
    ...
    pub struct VestedAmountReturn(pub ::ethers::core::types::U256);
    ...
    pub struct VestedAmountWithTokenReturn(pub ::ethers::core::types::U256);
}
