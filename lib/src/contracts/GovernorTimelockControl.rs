...
pub mod governor_timelock_control {
    ...
    impl ::ethers::core::abi::AbiDecode for GovernorTimelockControlErrors {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for GovernorTimelockControlErrors {
    ...
    impl ::ethers::contract::ContractRevert for GovernorTimelockControlErrors {
