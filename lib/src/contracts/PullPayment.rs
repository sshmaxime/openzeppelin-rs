...
pub mod pull_payment {
    ...
    pub static PULLPAYMENT_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(||
    ::ethers::core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid"));
    pub struct PullPayment<M>(::ethers::contract::Contract<M>);
    ...
    impl<M: ::ethers::providers::Middleware> PullPayment<M> {
    ...
    impl ::ethers::core::abi::AbiDecode for PullPaymentCalls {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::AbiError> {
            let data = data.as_ref();
            if let Ok(decoded)
                = <PaymentsCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::Payments(decoded));
            }
            if let Ok(decoded)
                = <WithdrawPaymentsCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
    ...
    impl ::ethers::core::abi::AbiEncode for PullPaymentCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                Self::Payments(element) => {
    ...
    pub struct PaymentsReturn(pub ::ethers::core::types::U256);
}
