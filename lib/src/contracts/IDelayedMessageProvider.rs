...
pub mod i_delayed_message_provider {
    ...
    pub static IDELAYEDMESSAGEPROVIDER_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    > = ::ethers::contract::Lazy::new(|| {
        ::ethers::core::utils::__serde_json::from_str(__ABI)
            .expect("ABI is always valid")
    });
    pub struct IDelayedMessageProvider<M>(::ethers::contract::Contract<M>);
    ...
    impl<M: ::ethers::providers::Middleware> IDelayedMessageProvider<M> {
    ...
    impl ::ethers::contract::EthLogDecode for IDelayedMessageProviderEvents {
        fn decode_log(
