...
pub mod governor_prevent_late_quorum {
    ...
    pub static GOVERNORPREVENTLATEQUORUM_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    > = ::ethers::contract::Lazy::new(|| {
        ::ethers::core::utils::__serde_json::from_str(__ABI)
            .expect("ABI is always valid")
    });
    pub struct GovernorPreventLateQuorum<M>(::ethers::contract::Contract<M>);
    ...
    impl<M: ::ethers::providers::Middleware> GovernorPreventLateQuorum<M> {
    ...
    impl ::ethers::core::abi::AbiDecode for GovernorPreventLateQuorumErrors {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for GovernorPreventLateQuorumErrors {
    ...
    impl ::ethers::contract::ContractRevert for GovernorPreventLateQuorumErrors {
    ...
    impl ::ethers::contract::EthLogDecode for GovernorPreventLateQuorumEvents {
        fn decode_log(
    ...
    impl ::ethers::core::abi::AbiDecode for GovernorPreventLateQuorumCalls {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::AbiError> {
            let data = data.as_ref();
            ...
            if let Ok(decoded)
                = <LateQuorumVoteExtensionCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
            ...
            if let Ok(decoded)
                = <SetLateQuorumVoteExtensionCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
    ...
    impl ::ethers::core::abi::AbiEncode for GovernorPreventLateQuorumCalls {
