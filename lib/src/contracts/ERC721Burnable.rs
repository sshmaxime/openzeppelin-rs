...
pub mod erc721_burnable {
    ...
    pub static ERC721BURNABLE_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(||
    ::ethers::core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid"));
    pub struct ERC721Burnable<M>(::ethers::contract::Contract<M>);
    ...
    impl<M: ::ethers::providers::Middleware> ERC721Burnable<M> {
    ...
    impl ::ethers::contract::EthLogDecode for ERC721BurnableEvents {
        fn decode_log(
    ...
    impl ::ethers::core::abi::AbiDecode for ERC721BurnableCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for ERC721BurnableCalls {
