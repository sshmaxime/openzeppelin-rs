...
pub mod ownable {
    ...
    pub static OWNABLE_ABI: ::ethers_contract::Lazy<::ethers_core::abi::Abi> = ::ethers_contract::Lazy::new(||
    ...
    impl<M: ::ethers_providers::Middleware> Ownable<M> {
    ...
    impl ::ethers_core::abi::AbiDecode for OwnableCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers_core::abi::AbiEncode for OwnableCalls {
