...
pub mod governor_counting_simple {
    ...
    pub static GOVERNORCOUNTINGSIMPLE_ABI: ::ethers_contract::Lazy<
        ::ethers_core::abi::Abi,
    > = ::ethers_contract::Lazy::new(|| {
        ::ethers_core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid")
    });
    pub struct GovernorCountingSimple<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers_providers::Middleware> GovernorCountingSimple<M> {
    ...
    impl ::ethers_core::abi::AbiDecode for GovernorCountingSimpleErrors {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers_core::abi::AbiEncode for GovernorCountingSimpleErrors {
    ...
    impl ::ethers_contract::ContractRevert for GovernorCountingSimpleErrors {
    ...
    impl ::ethers_contract::EthLogDecode for GovernorCountingSimpleEvents {
        fn decode_log(
    ...
    impl ::ethers_core::abi::AbiDecode for GovernorCountingSimpleCalls {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> ::core::result::Result<Self, ::ethers_core::abi::AbiError> {
            let data = data.as_ref();
            ...
            if let Ok(decoded)
                = <ProposalVotesCall as ::ethers_core::abi::AbiDecode>::decode(data) {
    ...
    impl ::ethers_core::abi::AbiEncode for GovernorCountingSimpleCalls {
