...
pub mod governor_proposal_threshold {
    ...
    pub static GOVERNORPROPOSALTHRESHOLD_ABI: ::ethers_contract::Lazy<
        ::ethers_core::abi::Abi,
    > = ::ethers_contract::Lazy::new(|| {
        ::ethers_core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid")
    });
    pub struct GovernorProposalThreshold<M>(::ethers_contract::Contract<M>);
    impl<M> ::core::clone::Clone for GovernorProposalThreshold<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for GovernorProposalThreshold<M> {
        type Target = ::ethers_contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for GovernorProposalThreshold<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for GovernorProposalThreshold<M> {
    ...
    impl<M: ::ethers_providers::Middleware> GovernorProposalThreshold<M> {
        ...
        pub fn new<T: Into<::ethers_core::types::Address>>(
            ...
            Self(
                ::ethers_contract::Contract::new(
                    address.into(),
                    GOVERNORPROPOSALTHRESHOLD_ABI.clone(),
                    client,
                ),
            )
        }
        ...
        pub fn events(
            ...
            ::std::sync::Arc<M>,
            M,
            GovernorProposalThresholdEvents,
        > {
            self.0.event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers_providers::Middleware> From<::ethers_contract::Contract<M>>
    for GovernorProposalThreshold<M> {
    ...
    pub enum GovernorProposalThresholdErrors {
        Empty(Empty),
    ...
    impl ::ethers_core::abi::AbiDecode for GovernorProposalThresholdErrors {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers_core::abi::AbiEncode for GovernorProposalThresholdErrors {
    ...
    impl ::ethers_contract::ContractRevert for GovernorProposalThresholdErrors {
    ...
    impl ::core::fmt::Display for GovernorProposalThresholdErrors {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    for GovernorProposalThresholdErrors {
        fn from(value: String) -> Self {
            Self::RevertString(value)
        }
    }
    impl ::core::convert::From<Empty> for GovernorProposalThresholdErrors {
        fn from(value: Empty) -> Self {
            Self::Empty(value)
        }
    }
    impl ::core::convert::From<InvalidShortString> for GovernorProposalThresholdErrors {
        fn from(value: InvalidShortString) -> Self {
            Self::InvalidShortString(value)
        }
    }
    impl ::core::convert::From<StringTooLong> for GovernorProposalThresholdErrors {
    ...
    #[derive(Clone, ::ethers_contract::EthAbiType, Debug, PartialEq, Eq, Hash)]
    pub enum GovernorProposalThresholdEvents {
    ...
    impl ::ethers_contract::EthLogDecode for GovernorProposalThresholdEvents {
        fn decode_log(
            log: &::ethers_core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers_core::abi::Error> {
            if let Ok(decoded) = Eip712DomainChangedFilter::decode_log(log) {
                return Ok(
                    GovernorProposalThresholdEvents::Eip712DomainChangedFilter(decoded),
                );
            }
            if let Ok(decoded) = ProposalCanceledFilter::decode_log(log) {
                return Ok(
                    GovernorProposalThresholdEvents::ProposalCanceledFilter(decoded),
                );
            }
            if let Ok(decoded) = ProposalCreatedFilter::decode_log(log) {
                return Ok(
                    GovernorProposalThresholdEvents::ProposalCreatedFilter(decoded),
                );
            }
            if let Ok(decoded) = ProposalExecutedFilter::decode_log(log) {
                return Ok(
                    GovernorProposalThresholdEvents::ProposalExecutedFilter(decoded),
                );
            }
            if let Ok(decoded) = VoteCastFilter::decode_log(log) {
                return Ok(GovernorProposalThresholdEvents::VoteCastFilter(decoded));
            }
            if let Ok(decoded) = VoteCastWithParamsFilter::decode_log(log) {
                return Ok(
                    GovernorProposalThresholdEvents::VoteCastWithParamsFilter(decoded),
                );
            }
            Err(::ethers_core::abi::Error::InvalidData)
        }
    }
    impl ::core::fmt::Display for GovernorProposalThresholdEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    for GovernorProposalThresholdEvents {
    ...
    impl ::core::convert::From<VoteCastFilter> for GovernorProposalThresholdEvents {
    ...
    #[derive(Clone, ::ethers_contract::EthAbiType, Debug, PartialEq, Eq, Hash)]
    pub enum GovernorProposalThresholdCalls {
    ...
    impl ::ethers_core::abi::AbiDecode for GovernorProposalThresholdCalls {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> ::core::result::Result<Self, ::ethers_core::abi::AbiError> {
            let data = data.as_ref();
    ...
    impl ::ethers_core::abi::AbiEncode for GovernorProposalThresholdCalls {
    ...
    impl ::core::fmt::Display for GovernorProposalThresholdCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<BallotTypehashCall> for GovernorProposalThresholdCalls {
        fn from(value: BallotTypehashCall) -> Self {
            Self::BallotTypehash(value)
        }
    }
    impl ::core::convert::From<ClockModeCall> for GovernorProposalThresholdCalls {
        fn from(value: ClockModeCall) -> Self {
            Self::ClockMode(value)
        }
    }
    impl ::core::convert::From<CountingModeCall> for GovernorProposalThresholdCalls {
        fn from(value: CountingModeCall) -> Self {
            Self::CountingMode(value)
        }
    }
    impl ::core::convert::From<ExtendedBallotTypehashCall>
    for GovernorProposalThresholdCalls {
        fn from(value: ExtendedBallotTypehashCall) -> Self {
            Self::ExtendedBallotTypehash(value)
        }
    }
    impl ::core::convert::From<CancelCall> for GovernorProposalThresholdCalls {
        fn from(value: CancelCall) -> Self {
            Self::Cancel(value)
        }
    }
    impl ::core::convert::From<CastVoteCall> for GovernorProposalThresholdCalls {
        fn from(value: CastVoteCall) -> Self {
            Self::CastVote(value)
        }
    }
    impl ::core::convert::From<CastVoteBySigCall> for GovernorProposalThresholdCalls {
    ...
    impl ::core::convert::From<ClockCall> for GovernorProposalThresholdCalls {
        fn from(value: ClockCall) -> Self {
            Self::Clock(value)
        }
    }
    impl ::core::convert::From<Eip712DomainCall> for GovernorProposalThresholdCalls {
        fn from(value: Eip712DomainCall) -> Self {
            Self::Eip712Domain(value)
        }
    }
    impl ::core::convert::From<ExecuteCall> for GovernorProposalThresholdCalls {
        fn from(value: ExecuteCall) -> Self {
            Self::Execute(value)
        }
    }
    impl ::core::convert::From<GetVotesCall> for GovernorProposalThresholdCalls {
    ...
    impl ::core::convert::From<HasVotedCall> for GovernorProposalThresholdCalls {
        fn from(value: HasVotedCall) -> Self {
            Self::HasVoted(value)
        }
    }
    impl ::core::convert::From<HashProposalCall> for GovernorProposalThresholdCalls {
        fn from(value: HashProposalCall) -> Self {
            Self::HashProposal(value)
        }
    }
    impl ::core::convert::From<NameCall> for GovernorProposalThresholdCalls {
    ...
    impl ::core::convert::From<OnERC721ReceivedCall> for GovernorProposalThresholdCalls {
        fn from(value: OnERC721ReceivedCall) -> Self {
            Self::OnERC721Received(value)
        }
    }
    impl ::core::convert::From<ProposalDeadlineCall> for GovernorProposalThresholdCalls {
        fn from(value: ProposalDeadlineCall) -> Self {
            Self::ProposalDeadline(value)
        }
    }
    impl ::core::convert::From<ProposalProposerCall> for GovernorProposalThresholdCalls {
        fn from(value: ProposalProposerCall) -> Self {
            Self::ProposalProposer(value)
        }
    }
    impl ::core::convert::From<ProposalSnapshotCall> for GovernorProposalThresholdCalls {
    ...
    impl ::core::convert::From<ProposeCall> for GovernorProposalThresholdCalls {
        fn from(value: ProposeCall) -> Self {
            Self::Propose(value)
        }
    }
    impl ::core::convert::From<QuorumCall> for GovernorProposalThresholdCalls {
        fn from(value: QuorumCall) -> Self {
            Self::Quorum(value)
        }
    }
    impl ::core::convert::From<RelayCall> for GovernorProposalThresholdCalls {
        fn from(value: RelayCall) -> Self {
            Self::Relay(value)
        }
    }
    impl ::core::convert::From<StateCall> for GovernorProposalThresholdCalls {
    ...
    impl ::core::convert::From<VersionCall> for GovernorProposalThresholdCalls {
        fn from(value: VersionCall) -> Self {
            Self::Version(value)
        }
    }
    impl ::core::convert::From<VotingDelayCall> for GovernorProposalThresholdCalls {
        fn from(value: VotingDelayCall) -> Self {
            Self::VotingDelay(value)
        }
    }
    impl ::core::convert::From<VotingPeriodCall> for GovernorProposalThresholdCalls {
