...
pub mod ierc721_metadata {
    ...
    pub static IERC721METADATA_ABI: ::ethers_contract::Lazy<::ethers_core::abi::Abi> = ::ethers_contract::Lazy::new(||
    ::ethers_core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid"));
    pub struct IERC721Metadata<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers_providers::Middleware> IERC721Metadata<M> {
    ...
    impl ::ethers_contract::EthLogDecode for IERC721MetadataEvents {
        fn decode_log(
    ...
    impl ::ethers_core::abi::AbiDecode for IERC721MetadataCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers_core::abi::AbiEncode for IERC721MetadataCalls {
