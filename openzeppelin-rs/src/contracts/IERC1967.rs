...
pub mod ierc1967 {
    ...
    pub static IERC1967_ABI: ::ethers_contract::Lazy<::ethers_core::abi::Abi> = ::ethers_contract::Lazy::new(||
    ::ethers_core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid"));
    pub struct IERC1967<M>(::ethers_contract::Contract<M>);
    ...
    impl<M> ::core::fmt::Debug for IERC1967<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(IERC1967)).field(&self.address()).finish()
        }
    }
    impl<M: ::ethers_providers::Middleware> IERC1967<M> {
        ...
        pub fn events(
            &self,
        ) -> ::ethers_contract::builders::Event<::std::sync::Arc<M>, M, IERC1967Events> {
    ...
    impl ::ethers_contract::EthLogDecode for IERC1967Events {
        fn decode_log(
