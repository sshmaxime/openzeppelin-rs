...
pub mod proxy {
    ...
    pub static PROXY_ABI: ::ethers_contract::Lazy<::ethers_core::abi::Abi> = ::ethers_contract::Lazy::new(||
    ::ethers_core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid"));
    pub struct Proxy<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers_providers::Middleware> Proxy<M> {
