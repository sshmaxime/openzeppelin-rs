...
pub mod erc1820_implementer {
    ...
    pub static ERC1820IMPLEMENTER_ABI: ::ethers_contract::Lazy<
        ::ethers_core::abi::Abi,
    ...
    pub static ERC1820IMPLEMENTER_BYTECODE: ::ethers_core::types::Bytes = ::ethers_core::types::Bytes::from_static(
        __BYTECODE,
    );
    #[rustfmt::skip]
    ...
    pub static ERC1820IMPLEMENTER_DEPLOYED_BYTECODE: ::ethers_core::types::Bytes = ::ethers_core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    pub struct ERC1820Implementer<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers_providers::Middleware> ERC1820Implementer<M> {
