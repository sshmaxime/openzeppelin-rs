...
pub mod transparent_upgradeable_proxy {
    ...
    pub static TRANSPARENTUPGRADEABLEPROXY_ABI: ::ethers_contract::Lazy<
        ::ethers_core::abi::Abi,
    ...
    pub static TRANSPARENTUPGRADEABLEPROXY_BYTECODE: ::ethers_core::types::Bytes = ::ethers_core::types::Bytes::from_static(
        __BYTECODE,
    );
    #[rustfmt::skip]
    ...
    pub static TRANSPARENTUPGRADEABLEPROXY_DEPLOYED_BYTECODE: ::ethers_core::types::Bytes = ::ethers_core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    pub struct TransparentUpgradeableProxy<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers_providers::Middleware> TransparentUpgradeableProxy<M> {
    ...
    impl ::ethers_contract::EthLogDecode for TransparentUpgradeableProxyEvents {
        fn decode_log(
