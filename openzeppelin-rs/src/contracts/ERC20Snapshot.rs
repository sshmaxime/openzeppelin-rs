...
pub mod erc20_snapshot {
    ...
    pub static ERC20SNAPSHOT_ABI: ::ethers_contract::Lazy<::ethers_core::abi::Abi> = ::ethers_contract::Lazy::new(||
    ::ethers_core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid"));
    pub struct ERC20Snapshot<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers_providers::Middleware> ERC20Snapshot<M> {
        ...
        pub fn balance_of_at(
            &self,
            account: ::ethers_core::types::Address,
            snapshot_id: ::ethers_core::types::U256,
        ) -> ::ethers_contract::builders::ContractCall<M, ::ethers_core::types::U256> {
            self.0
        ...
        pub fn snapshot_filter(
            &self,
        ) -> ::ethers_contract::builders::Event<::std::sync::Arc<M>, M, SnapshotFilter> {
            self.0.event()
        }
    ...
    impl ::ethers_contract::EthLogDecode for ERC20SnapshotEvents {
        fn decode_log(
    ...
    pub struct BalanceOfAtCall {
        pub account: ::ethers_core::types::Address,
        pub snapshot_id: ::ethers_core::types::U256,
    }
    ...
    impl ::ethers_core::abi::AbiDecode for ERC20SnapshotCalls {
        fn decode(
            data: impl AsRef<[u8]>,
            ...
            if let Ok(decoded)
                = <BalanceOfAtCall as ::ethers_core::abi::AbiDecode>::decode(data) {
            ...
            if let Ok(decoded)
                = <TotalSupplyAtCall as ::ethers_core::abi::AbiDecode>::decode(data) {
    ...
    impl ::ethers_core::abi::AbiEncode for ERC20SnapshotCalls {
    ...
    pub struct BalanceOfAtReturn(pub ::ethers_core::types::U256);
    ...
    pub struct TotalSupplyAtReturn(pub ::ethers_core::types::U256);
