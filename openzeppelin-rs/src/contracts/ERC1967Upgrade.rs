...
pub mod erc1967_upgrade {
    ...
    pub static ERC1967UPGRADE_ABI: ::ethers_contract::Lazy<::ethers_core::abi::Abi> = ::ethers_contract::Lazy::new(||
    ::ethers_core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid"));
    pub struct ERC1967Upgrade<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers_providers::Middleware> ERC1967Upgrade<M> {
    ...
    impl ::ethers_contract::EthLogDecode for ERC1967UpgradeEvents {
        fn decode_log(
