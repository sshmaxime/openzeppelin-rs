...
pub mod erc1967_proxy {
    ...
    pub static ERC1967PROXY_ABI: ::ethers_contract::Lazy<::ethers_core::abi::Abi> = ::ethers_contract::Lazy::new(||
    ...
    pub static ERC1967PROXY_BYTECODE: ::ethers_core::types::Bytes = ::ethers_core::types::Bytes::from_static(
        __BYTECODE,
    );
    #[rustfmt::skip]
    ...
    pub static ERC1967PROXY_DEPLOYED_BYTECODE: ::ethers_core::types::Bytes = ::ethers_core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    pub struct ERC1967Proxy<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers_providers::Middleware> ERC1967Proxy<M> {
    ...
    impl ::ethers_contract::EthLogDecode for ERC1967ProxyEvents {
        fn decode_log(
