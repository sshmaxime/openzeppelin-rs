...
pub mod erc721_royalty {
    ...
    pub static ERC721ROYALTY_ABI: ::ethers_contract::Lazy<::ethers_core::abi::Abi> = ::ethers_contract::Lazy::new(||
    ::ethers_core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid"));
    pub struct ERC721Royalty<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers_providers::Middleware> ERC721Royalty<M> {
    ...
    impl ::ethers_contract::EthLogDecode for ERC721RoyaltyEvents {
        fn decode_log(
    ...
    impl ::ethers_core::abi::AbiDecode for ERC721RoyaltyCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers_core::abi::AbiEncode for ERC721RoyaltyCalls {
