...
pub mod escrow {
    ...
    pub static ESCROW_ABI: ::ethers_contract::Lazy<::ethers_core::abi::Abi> = ::ethers_contract::Lazy::new(||
    ...
    pub static ESCROW_BYTECODE: ::ethers_core::types::Bytes = ::ethers_core::types::Bytes::from_static(
        __BYTECODE,
    );
    #[rustfmt::skip]
    ...
    pub static ESCROW_DEPLOYED_BYTECODE: ::ethers_core::types::Bytes = ::ethers_core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    pub struct Escrow<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers_providers::Middleware> Escrow<M> {
        ...
        pub fn events(
            &self,
        ) -> ::ethers_contract::builders::Event<::std::sync::Arc<M>, M, EscrowEvents> {
    ...
    impl ::ethers_contract::EthLogDecode for EscrowEvents {
        fn decode_log(
    ...
    impl ::ethers_core::abi::AbiDecode for EscrowCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers_core::abi::AbiEncode for EscrowCalls {
