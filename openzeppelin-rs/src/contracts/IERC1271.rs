...
pub mod ierc1271 {
    ...
    pub static IERC1271_ABI: ::ethers_contract::Lazy<::ethers_core::abi::Abi> = ::ethers_contract::Lazy::new(||
    ::ethers_core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid"));
    pub struct IERC1271<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers_providers::Middleware> IERC1271<M> {
