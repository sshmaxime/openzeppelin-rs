...
pub mod erc20_burnable {
    ...
    pub static ERC20BURNABLE_ABI: ::ethers_contract::Lazy<::ethers_core::abi::Abi> = ::ethers_contract::Lazy::new(||
    ::ethers_core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid"));
    pub struct ERC20Burnable<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers_providers::Middleware> ERC20Burnable<M> {
    ...
    impl ::ethers_contract::EthLogDecode for ERC20BurnableEvents {
        fn decode_log(
    ...
    impl ::ethers_core::abi::AbiDecode for ERC20BurnableCalls {
        fn decode(
            data: impl AsRef<[u8]>,
            ...
            if let Ok(decoded)
                = <BurnFromCall as ::ethers_core::abi::AbiDecode>::decode(data) {
    ...
    impl ::ethers_core::abi::AbiEncode for ERC20BurnableCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                Self::BurnFrom(element) => ::ethers_core::abi::AbiEncode::encode(element),
