...
pub mod i_governor_compatibility_bravo {
    ...
    pub static IGOVERNORCOMPATIBILITYBRAVO_ABI: ::ethers_contract::Lazy<
        ::ethers_core::abi::Abi,
    > = ::ethers_contract::Lazy::new(|| {
        ::ethers_core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid")
    });
    pub struct IGovernorCompatibilityBravo<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers_providers::Middleware> IGovernorCompatibilityBravo<M> {
    ...
    impl ::ethers_contract::EthLogDecode for IGovernorCompatibilityBravoEvents {
        fn decode_log(
    ...
    pub struct ProposalsCall(pub ::ethers_core::types::U256);
    ...
    impl ::ethers_core::abi::AbiDecode for IGovernorCompatibilityBravoCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers_core::abi::AbiEncode for IGovernorCompatibilityBravoCalls {
