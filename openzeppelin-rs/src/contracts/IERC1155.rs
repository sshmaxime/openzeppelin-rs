...
pub mod ierc1155 {
    ...
    pub static IERC1155_ABI: ::ethers_contract::Lazy<::ethers_core::abi::Abi> = ::ethers_contract::Lazy::new(||
    ::ethers_core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid"));
    pub struct IERC1155<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers_providers::Middleware> IERC1155<M> {
        ...
        pub fn events(
            &self,
        ) -> ::ethers_contract::builders::Event<::std::sync::Arc<M>, M, IERC1155Events> {
    ...
    impl ::ethers_contract::EthLogDecode for IERC1155Events {
        fn decode_log(
    ...
    impl ::ethers_core::abi::AbiDecode for IERC1155Calls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers_core::abi::AbiEncode for IERC1155Calls {
