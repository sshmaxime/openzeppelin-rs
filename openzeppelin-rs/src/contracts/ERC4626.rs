...
pub mod erc4626 {
    ...
    pub static ERC4626_ABI: ::ethers_contract::Lazy<::ethers_core::abi::Abi> = ::ethers_contract::Lazy::new(||
    ::ethers_core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid"));
    pub struct ERC4626<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers_providers::Middleware> ERC4626<M> {
        ...
        pub fn events(
            &self,
        ) -> ::ethers_contract::builders::Event<::std::sync::Arc<M>, M, ERC4626Events> {
    ...
    impl ::ethers_contract::EthLogDecode for ERC4626Events {
        fn decode_log(
    ...
    pub struct MaxDepositCall(pub ::ethers_core::types::Address);
    ...
    pub struct MaxMintCall(pub ::ethers_core::types::Address);
    ...
    impl ::ethers_core::abi::AbiDecode for ERC4626Calls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers_core::abi::AbiEncode for ERC4626Calls {
    ...
    pub struct AssetReturn(pub ::ethers_core::types::Address);
    ...
    pub struct ConvertToAssetsReturn(pub ::ethers_core::types::U256);
    ...
    pub struct ConvertToSharesReturn(pub ::ethers_core::types::U256);
    ...
    pub struct DepositReturn(pub ::ethers_core::types::U256);
    ...
    pub struct MaxDepositReturn(pub ::ethers_core::types::U256);
    ...
    pub struct MaxMintReturn(pub ::ethers_core::types::U256);
    ...
    pub struct MaxRedeemReturn(pub ::ethers_core::types::U256);
    ...
    pub struct MaxWithdrawReturn(pub ::ethers_core::types::U256);
    ...
    pub struct MintReturn(pub ::ethers_core::types::U256);
    ...
    pub struct PreviewDepositReturn(pub ::ethers_core::types::U256);
    ...
    pub struct PreviewMintReturn(pub ::ethers_core::types::U256);
    ...
    pub struct PreviewRedeemReturn(pub ::ethers_core::types::U256);
    ...
    pub struct PreviewWithdrawReturn(pub ::ethers_core::types::U256);
    ...
    pub struct RedeemReturn(pub ::ethers_core::types::U256);
    ...
    pub struct TotalAssetsReturn(pub ::ethers_core::types::U256);
    ...
    pub struct WithdrawReturn(pub ::ethers_core::types::U256);
}
