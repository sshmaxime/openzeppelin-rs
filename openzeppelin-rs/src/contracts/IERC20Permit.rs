...
pub mod ierc20_permit {
    ...
    pub static IERC20PERMIT_ABI: ::ethers_contract::Lazy<::ethers_core::abi::Abi> = ::ethers_contract::Lazy::new(||
    ::ethers_core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid"));
    pub struct IERC20Permit<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers_providers::Middleware> IERC20Permit<M> {
    ...
    impl ::ethers_core::abi::AbiDecode for IERC20PermitCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers_core::abi::AbiEncode for IERC20PermitCalls {
