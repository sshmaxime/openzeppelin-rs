...
pub mod cross_chain_enabled_arbitrum_l2 {
    ...
    pub static CROSSCHAINENABLEDARBITRUML2_ABI: ::ethers_contract::Lazy<
        ::ethers_core::abi::Abi,
    > = ::ethers_contract::Lazy::new(|| {
        ::ethers_core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid")
    });
    pub struct CrossChainEnabledArbitrumL2<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers_providers::Middleware> CrossChainEnabledArbitrumL2<M> {
