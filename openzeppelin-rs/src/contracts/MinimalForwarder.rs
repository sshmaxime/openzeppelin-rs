...
pub mod minimal_forwarder {
    ...
    pub static MINIMALFORWARDER_ABI: ::ethers_contract::Lazy<::ethers_core::abi::Abi> = ::ethers_contract::Lazy::new(||
    ...
    pub static MINIMALFORWARDER_BYTECODE: ::ethers_core::types::Bytes = ::ethers_core::types::Bytes::from_static(
        __BYTECODE,
    );
    #[rustfmt::skip]
    ...
    pub static MINIMALFORWARDER_DEPLOYED_BYTECODE: ::ethers_core::types::Bytes = ::ethers_core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    pub struct MinimalForwarder<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers_providers::Middleware> MinimalForwarder<M> {
    ...
    impl ::ethers_core::abi::AbiDecode for MinimalForwarderErrors {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers_core::abi::AbiEncode for MinimalForwarderErrors {
    ...
    impl ::ethers_contract::ContractRevert for MinimalForwarderErrors {
    ...
    impl ::ethers_core::abi::AbiDecode for MinimalForwarderCalls {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> ::core::result::Result<Self, ::ethers_core::abi::AbiError> {
            let data = data.as_ref();
            ...
            if let Ok(decoded)
                = <VerifyCall as ::ethers_core::abi::AbiDecode>::decode(data) {
                return Ok(Self::Verify(decoded));
            }
            Err(::ethers_core::abi::Error::InvalidData.into())
        }
    }
    impl ::ethers_core::abi::AbiEncode for MinimalForwarderCalls {
    ...
    pub struct ExecuteReturn(pub bool, pub ::ethers_core::types::Bytes);
    ...
    pub struct GetNonceReturn(pub ::ethers_core::types::U256);
