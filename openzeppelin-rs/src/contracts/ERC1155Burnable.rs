...
pub mod erc1155_burnable {
    ...
    pub static ERC1155BURNABLE_ABI: ::ethers_contract::Lazy<::ethers_core::abi::Abi> = ::ethers_contract::Lazy::new(||
    ::ethers_core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid"));
    pub struct ERC1155Burnable<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers_providers::Middleware> ERC1155Burnable<M> {
    ...
    impl ::ethers_contract::EthLogDecode for ERC1155BurnableEvents {
        fn decode_log(
    ...
    impl ::ethers_core::abi::AbiDecode for ERC1155BurnableCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers_core::abi::AbiEncode for ERC1155BurnableCalls {
