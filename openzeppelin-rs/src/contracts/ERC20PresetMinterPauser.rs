...
pub mod erc20_preset_minter_pauser {
    ...
    pub static ERC20PRESETMINTERPAUSER_ABI: ::ethers_contract::Lazy<
        ::ethers_core::abi::Abi,
    ...
    pub static ERC20PRESETMINTERPAUSER_BYTECODE: ::ethers_core::types::Bytes = ::ethers_core::types::Bytes::from_static(
        __BYTECODE,
    );
    #[rustfmt::skip]
    ...
    pub static ERC20PRESETMINTERPAUSER_DEPLOYED_BYTECODE: ::ethers_core::types::Bytes = ::ethers_core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    pub struct ERC20PresetMinterPauser<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers_providers::Middleware> ERC20PresetMinterPauser<M> {
    ...
    impl ::ethers_contract::EthLogDecode for ERC20PresetMinterPauserEvents {
        fn decode_log(
    ...
    impl ::ethers_core::abi::AbiDecode for ERC20PresetMinterPauserCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers_core::abi::AbiEncode for ERC20PresetMinterPauserCalls {
