...
pub mod governor_settings {
    ...
    pub static GOVERNORSETTINGS_ABI: ::ethers_contract::Lazy<::ethers_core::abi::Abi> = ::ethers_contract::Lazy::new(||
    ::ethers_core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid"));
    pub struct GovernorSettings<M>(::ethers_contract::Contract<M>);
    ...
    impl<M> ::core::fmt::Debug for GovernorSettings<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(GovernorSettings)).field(&self.address()).finish()
        }
    }
    impl<M: ::ethers_providers::Middleware> GovernorSettings<M> {
        ...
        pub fn set_proposal_threshold(
            &self,
            new_proposal_threshold: ::ethers_core::types::U256,
        ) -> ::ethers_contract::builders::ContractCall<M, ()> {
            self.0
        ...
        pub fn set_voting_delay(
            &self,
            new_voting_delay: ::ethers_core::types::U256,
        ) -> ::ethers_contract::builders::ContractCall<M, ()> {
            self.0
        ...
        pub fn set_voting_period(
            &self,
            new_voting_period: ::ethers_core::types::U256,
        ) -> ::ethers_contract::builders::ContractCall<M, ()> {
            self.0
    ...
    impl ::ethers_core::abi::AbiDecode for GovernorSettingsErrors {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers_core::abi::AbiEncode for GovernorSettingsErrors {
    ...
    impl ::ethers_contract::ContractRevert for GovernorSettingsErrors {
    ...
    pub struct ProposalThresholdSetFilter {
        pub old_proposal_threshold: ::ethers_core::types::U256,
        pub new_proposal_threshold: ::ethers_core::types::U256,
    }
    #[derive(
        Clone,
        ::ethers_contract::EthEvent,
    ...
    pub struct VotingDelaySetFilter {
        pub old_voting_delay: ::ethers_core::types::U256,
        pub new_voting_delay: ::ethers_core::types::U256,
    }
    #[derive(
        Clone,
        ::ethers_contract::EthEvent,
    ...
    pub struct VotingPeriodSetFilter {
        pub old_voting_period: ::ethers_core::types::U256,
        pub new_voting_period: ::ethers_core::types::U256,
    }
    ...
    impl ::ethers_contract::EthLogDecode for GovernorSettingsEvents {
        fn decode_log(
    ...
    impl ::ethers_core::abi::AbiDecode for GovernorSettingsCalls {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> ::core::result::Result<Self, ::ethers_core::abi::AbiError> {
            let data = data.as_ref();
            ...
            if let Ok(decoded)
                = <SetProposalThresholdCall as ::ethers_core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::SetProposalThreshold(decoded));
            }
            if let Ok(decoded)
                = <SetVotingDelayCall as ::ethers_core::abi::AbiDecode>::decode(data) {
                return Ok(Self::SetVotingDelay(decoded));
            }
            if let Ok(decoded)
                = <SetVotingPeriodCall as ::ethers_core::abi::AbiDecode>::decode(data) {
    ...
    impl ::ethers_core::abi::AbiEncode for GovernorSettingsCalls {
