...
pub mod lib_arbitrum_l2 {
    ...
    pub static LIBARBITRUML2_ABI: ::ethers_contract::Lazy<::ethers_core::abi::Abi> = ::ethers_contract::Lazy::new(||
    ...
    pub static LIBARBITRUML2_BYTECODE: ::ethers_core::types::Bytes = ::ethers_core::types::Bytes::from_static(
        __BYTECODE,
    );
    #[rustfmt::skip]
    ...
    pub static LIBARBITRUML2_DEPLOYED_BYTECODE: ::ethers_core::types::Bytes = ::ethers_core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    pub struct LibArbitrumL2<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers_providers::Middleware> LibArbitrumL2<M> {
    ...
    pub struct ArbsysReturn(pub ::ethers_core::types::Address);
}
