...
pub mod access_control {
    ...
    pub static ACCESSCONTROL_ABI: ::ethers_contract::Lazy<::ethers_core::abi::Abi> = ::ethers_contract::Lazy::new(||
    ::ethers_core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid"));
    pub struct AccessControl<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers_providers::Middleware> AccessControl<M> {
    ...
    impl ::ethers_contract::EthLogDecode for AccessControlEvents {
        fn decode_log(
    ...
    impl ::ethers_core::abi::AbiDecode for AccessControlCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers_core::abi::AbiEncode for AccessControlCalls {
