...
pub mod erc20_pausable {
    ...
    pub static ERC20PAUSABLE_ABI: ::ethers_contract::Lazy<::ethers_core::abi::Abi> = ::ethers_contract::Lazy::new(||
    ::ethers_core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid"));
    pub struct ERC20Pausable<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers_providers::Middleware> ERC20Pausable<M> {
    ...
    impl ::ethers_contract::EthLogDecode for ERC20PausableEvents {
        fn decode_log(
    ...
    impl ::ethers_core::abi::AbiDecode for ERC20PausableCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers_core::abi::AbiEncode for ERC20PausableCalls {
