...
pub mod i_outbox {
    ...
    pub static IOUTBOX_ABI: ::ethers_contract::Lazy<::ethers_core::abi::Abi> = ::ethers_contract::Lazy::new(||
    ::ethers_core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid"));
    pub struct IOutbox<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers_providers::Middleware> IOutbox<M> {
        ...
        pub fn calculate_item_hash(
            &self,
            l_2_sender: ::ethers_core::types::Address,
            to: ::ethers_core::types::Address,
            l_2_block: ::ethers_core::types::U256,
            l_1_block: ::ethers_core::types::U256,
            l_2_timestamp: ::ethers_core::types::U256,
        ...
        pub fn events(
            &self,
        ) -> ::ethers_contract::builders::Event<::std::sync::Arc<M>, M, IOutboxEvents> {
    ...
    pub struct OutBoxTransactionExecutedFilter {
        ...
        #[ethevent(indexed)]
        pub l_2_sender: ::ethers_core::types::Address,
        #[ethevent(indexed)]
        pub zero: ::ethers_core::types::U256,
    ...
    impl ::ethers_contract::EthLogDecode for IOutboxEvents {
        fn decode_log(
    ...
    pub struct CalculateItemHashCall {
        pub l_2_sender: ::ethers_core::types::Address,
        pub to: ::ethers_core::types::Address,
        pub l_2_block: ::ethers_core::types::U256,
        pub l_1_block: ::ethers_core::types::U256,
        pub l_2_timestamp: ::ethers_core::types::U256,
    ...
    pub struct CalculateMerkleRootCall {
        ...
        pub path: ::ethers_core::types::U256,
        pub item: [u8; 32],
    }
    ...
    pub struct SpentCall(pub ::ethers_core::types::U256);
    ...
    impl ::ethers_core::abi::AbiDecode for IOutboxCalls {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> ::core::result::Result<Self, ::ethers_core::abi::AbiError> {
            let data = data.as_ref();
            if let Ok(decoded)
                = <OutboxVersionCall as ::ethers_core::abi::AbiDecode>::decode(data) {
            ...
            if let Ok(decoded)
                = <CalculateItemHashCall as ::ethers_core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::CalculateItemHash(decoded));
            }
            if let Ok(decoded)
                = <CalculateMerkleRootCall as ::ethers_core::abi::AbiDecode>::decode(
                    data,
                ) {
            ...
            if let Ok(decoded)
                = <ExecuteTransactionSimulationCall as ::ethers_core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::ExecuteTransactionSimulation(decoded));
            }
            if let Ok(decoded)
                = <IsSpentCall as ::ethers_core::abi::AbiDecode>::decode(data) {
                return Ok(Self::IsSpent(decoded));
            }
            if let Ok(decoded)
                = <L2ToL1BlockCall as ::ethers_core::abi::AbiDecode>::decode(data) {
                return Ok(Self::L2ToL1Block(decoded));
            }
            if let Ok(decoded)
                = <L2ToL1EthBlockCall as ::ethers_core::abi::AbiDecode>::decode(data) {
                return Ok(Self::L2ToL1EthBlock(decoded));
            }
            if let Ok(decoded)
                = <L2ToL1OutputIdCall as ::ethers_core::abi::AbiDecode>::decode(data) {
                return Ok(Self::L2ToL1OutputId(decoded));
            }
            if let Ok(decoded)
                = <L2ToL1SenderCall as ::ethers_core::abi::AbiDecode>::decode(data) {
                return Ok(Self::L2ToL1Sender(decoded));
            }
            if let Ok(decoded)
                = <L2ToL1TimestampCall as ::ethers_core::abi::AbiDecode>::decode(data) {
            ...
            if let Ok(decoded)
                = <RootsCall as ::ethers_core::abi::AbiDecode>::decode(data) {
                return Ok(Self::Roots(decoded));
            }
            if let Ok(decoded)
                = <SpentCall as ::ethers_core::abi::AbiDecode>::decode(data) {
                return Ok(Self::Spent(decoded));
            }
            if let Ok(decoded)
                = <UpdateSendRootCall as ::ethers_core::abi::AbiDecode>::decode(data) {
                return Ok(Self::UpdateSendRoot(decoded));
            }
            Err(::ethers_core::abi::Error::InvalidData.into())
        }
    }
    impl ::ethers_core::abi::AbiEncode for IOutboxCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                Self::IsSpent(element) => ::ethers_core::abi::AbiEncode::encode(element),
                ...
                Self::Roots(element) => ::ethers_core::abi::AbiEncode::encode(element),
                Self::Spent(element) => ::ethers_core::abi::AbiEncode::encode(element),
    ...
    pub struct L2ToL1BlockReturn(pub ::ethers_core::types::U256);
    ...
    pub struct L2ToL1EthBlockReturn(pub ::ethers_core::types::U256);
    ...
    pub struct L2ToL1SenderReturn(pub ::ethers_core::types::Address);
    ...
    pub struct L2ToL1TimestampReturn(pub ::ethers_core::types::U256);
