...
pub mod token_timelock {
    ...
    pub static TOKENTIMELOCK_ABI: ::ethers_contract::Lazy<::ethers_core::abi::Abi> = ::ethers_contract::Lazy::new(||
    ...
    pub static TOKENTIMELOCK_BYTECODE: ::ethers_core::types::Bytes = ::ethers_core::types::Bytes::from_static(
        __BYTECODE,
    );
    #[rustfmt::skip]
    ...
    pub static TOKENTIMELOCK_DEPLOYED_BYTECODE: ::ethers_core::types::Bytes = ::ethers_core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    pub struct TokenTimelock<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers_providers::Middleware> TokenTimelock<M> {
    ...
    impl ::ethers_core::abi::AbiDecode for TokenTimelockCalls {
        fn decode(
            data: impl AsRef<[u8]>,
            ...
            if let Ok(decoded)
                = <ReleaseTimeCall as ::ethers_core::abi::AbiDecode>::decode(data) {
    ...
    impl ::ethers_core::abi::AbiEncode for TokenTimelockCalls {
    ...
    pub struct ReleaseTimeReturn(pub ::ethers_core::types::U256);
