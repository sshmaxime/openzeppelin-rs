pub use governor_prevent_late_quorum::*;
...
pub mod governor_prevent_late_quorum {
    #[rustfmt::skip]
    ...
    pub static GOVERNORPREVENTLATEQUORUM_ABI: ::ethers_contract::Lazy<
        ::ethers_core::abi::Abi,
    > = ::ethers_contract::Lazy::new(|| {
        ::ethers_core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid")
    });
    pub struct GovernorPreventLateQuorum<M>(::ethers_contract::Contract<M>);
    impl<M> ::core::clone::Clone for GovernorPreventLateQuorum<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for GovernorPreventLateQuorum<M> {
        type Target = ::ethers_contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for GovernorPreventLateQuorum<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for GovernorPreventLateQuorum<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(GovernorPreventLateQuorum))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers_providers::Middleware> GovernorPreventLateQuorum<M> {
        ...
        pub fn new<T: Into<::ethers_core::types::Address>>(
            ...
            Self(
                ::ethers_contract::Contract::new(
                    address.into(),
                    GOVERNORPREVENTLATEQUORUM_ABI.clone(),
                    client,
                ),
            )
        }
        ...
        pub fn events(
            ...
            ::std::sync::Arc<M>,
            M,
            GovernorPreventLateQuorumEvents,
        > {
            self.0.event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers_providers::Middleware> From<::ethers_contract::Contract<M>>
    for GovernorPreventLateQuorum<M> {
    ...
    pub enum GovernorPreventLateQuorumErrors {
        Empty(Empty),
    ...
    impl ::ethers_core::abi::AbiDecode for GovernorPreventLateQuorumErrors {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers_core::abi::AbiEncode for GovernorPreventLateQuorumErrors {
    ...
    impl ::ethers_contract::ContractRevert for GovernorPreventLateQuorumErrors {
    ...
    impl ::core::fmt::Display for GovernorPreventLateQuorumErrors {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    for GovernorPreventLateQuorumErrors {
        fn from(value: String) -> Self {
            Self::RevertString(value)
        }
    }
    impl ::core::convert::From<Empty> for GovernorPreventLateQuorumErrors {
        fn from(value: Empty) -> Self {
            Self::Empty(value)
        }
    }
    impl ::core::convert::From<InvalidShortString> for GovernorPreventLateQuorumErrors {
        fn from(value: InvalidShortString) -> Self {
            Self::InvalidShortString(value)
        }
    }
    impl ::core::convert::From<StringTooLong> for GovernorPreventLateQuorumErrors {
    ...
    #[derive(Clone, ::ethers_contract::EthAbiType, Debug, PartialEq, Eq, Hash)]
    pub enum GovernorPreventLateQuorumEvents {
    ...
    impl ::ethers_contract::EthLogDecode for GovernorPreventLateQuorumEvents {
        fn decode_log(
            log: &::ethers_core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers_core::abi::Error> {
            if let Ok(decoded) = Eip712DomainChangedFilter::decode_log(log) {
                return Ok(
                    GovernorPreventLateQuorumEvents::Eip712DomainChangedFilter(decoded),
                );
            }
            if let Ok(decoded) = LateQuorumVoteExtensionSetFilter::decode_log(log) {
                return Ok(
                    GovernorPreventLateQuorumEvents::LateQuorumVoteExtensionSetFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = ProposalCanceledFilter::decode_log(log) {
                return Ok(
                    GovernorPreventLateQuorumEvents::ProposalCanceledFilter(decoded),
                );
            }
            if let Ok(decoded) = ProposalCreatedFilter::decode_log(log) {
                return Ok(
                    GovernorPreventLateQuorumEvents::ProposalCreatedFilter(decoded),
                );
            }
            if let Ok(decoded) = ProposalExecutedFilter::decode_log(log) {
                return Ok(
                    GovernorPreventLateQuorumEvents::ProposalExecutedFilter(decoded),
                );
            }
            if let Ok(decoded) = ProposalExtendedFilter::decode_log(log) {
                return Ok(
                    GovernorPreventLateQuorumEvents::ProposalExtendedFilter(decoded),
                );
            }
            if let Ok(decoded) = VoteCastFilter::decode_log(log) {
                return Ok(GovernorPreventLateQuorumEvents::VoteCastFilter(decoded));
            }
            if let Ok(decoded) = VoteCastWithParamsFilter::decode_log(log) {
                return Ok(
                    GovernorPreventLateQuorumEvents::VoteCastWithParamsFilter(decoded),
                );
            }
            Err(::ethers_core::abi::Error::InvalidData)
        }
    }
    impl ::core::fmt::Display for GovernorPreventLateQuorumEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    for GovernorPreventLateQuorumEvents {
    ...
    impl ::core::convert::From<ProposalExtendedFilter>
    for GovernorPreventLateQuorumEvents {
        fn from(value: ProposalExtendedFilter) -> Self {
            Self::ProposalExtendedFilter(value)
        }
    }
    impl ::core::convert::From<VoteCastFilter> for GovernorPreventLateQuorumEvents {
    ...
    #[derive(Clone, ::ethers_contract::EthAbiType, Debug, PartialEq, Eq, Hash)]
    pub enum GovernorPreventLateQuorumCalls {
    ...
    impl ::ethers_core::abi::AbiDecode for GovernorPreventLateQuorumCalls {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> ::core::result::Result<Self, ::ethers_core::abi::AbiError> {
            let data = data.as_ref();
            ...
            if let Ok(decoded)
                = <LateQuorumVoteExtensionCall as ::ethers_core::abi::AbiDecode>::decode(
                    data,
                ) {
            ...
            if let Ok(decoded)
                = <SetLateQuorumVoteExtensionCall as ::ethers_core::abi::AbiDecode>::decode(
                    data,
                ) {
    ...
    impl ::ethers_core::abi::AbiEncode for GovernorPreventLateQuorumCalls {
    ...
    impl ::core::fmt::Display for GovernorPreventLateQuorumCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<BallotTypehashCall> for GovernorPreventLateQuorumCalls {
        fn from(value: BallotTypehashCall) -> Self {
            Self::BallotTypehash(value)
        }
    }
    impl ::core::convert::From<ClockModeCall> for GovernorPreventLateQuorumCalls {
        fn from(value: ClockModeCall) -> Self {
            Self::ClockMode(value)
        }
    }
    impl ::core::convert::From<CountingModeCall> for GovernorPreventLateQuorumCalls {
        fn from(value: CountingModeCall) -> Self {
            Self::CountingMode(value)
        }
    }
    impl ::core::convert::From<ExtendedBallotTypehashCall>
    for GovernorPreventLateQuorumCalls {
        fn from(value: ExtendedBallotTypehashCall) -> Self {
            Self::ExtendedBallotTypehash(value)
        }
    }
    impl ::core::convert::From<CancelCall> for GovernorPreventLateQuorumCalls {
        fn from(value: CancelCall) -> Self {
            Self::Cancel(value)
        }
    }
    impl ::core::convert::From<CastVoteCall> for GovernorPreventLateQuorumCalls {
        fn from(value: CastVoteCall) -> Self {
            Self::CastVote(value)
        }
    }
    impl ::core::convert::From<CastVoteBySigCall> for GovernorPreventLateQuorumCalls {
    ...
    impl ::core::convert::From<ClockCall> for GovernorPreventLateQuorumCalls {
        fn from(value: ClockCall) -> Self {
            Self::Clock(value)
        }
    }
    impl ::core::convert::From<Eip712DomainCall> for GovernorPreventLateQuorumCalls {
        fn from(value: Eip712DomainCall) -> Self {
            Self::Eip712Domain(value)
        }
    }
    impl ::core::convert::From<ExecuteCall> for GovernorPreventLateQuorumCalls {
        fn from(value: ExecuteCall) -> Self {
            Self::Execute(value)
        }
    }
    impl ::core::convert::From<GetVotesCall> for GovernorPreventLateQuorumCalls {
    ...
    impl ::core::convert::From<HasVotedCall> for GovernorPreventLateQuorumCalls {
        fn from(value: HasVotedCall) -> Self {
            Self::HasVoted(value)
        }
    }
    impl ::core::convert::From<HashProposalCall> for GovernorPreventLateQuorumCalls {
    ...
    impl ::core::convert::From<NameCall> for GovernorPreventLateQuorumCalls {
    ...
    impl ::core::convert::From<OnERC721ReceivedCall> for GovernorPreventLateQuorumCalls {
        fn from(value: OnERC721ReceivedCall) -> Self {
            Self::OnERC721Received(value)
        }
    }
    impl ::core::convert::From<ProposalDeadlineCall> for GovernorPreventLateQuorumCalls {
        fn from(value: ProposalDeadlineCall) -> Self {
            Self::ProposalDeadline(value)
        }
    }
    impl ::core::convert::From<ProposalProposerCall> for GovernorPreventLateQuorumCalls {
        fn from(value: ProposalProposerCall) -> Self {
            Self::ProposalProposer(value)
        }
    }
    impl ::core::convert::From<ProposalSnapshotCall> for GovernorPreventLateQuorumCalls {
    ...
    impl ::core::convert::From<ProposeCall> for GovernorPreventLateQuorumCalls {
        fn from(value: ProposeCall) -> Self {
            Self::Propose(value)
        }
    }
    impl ::core::convert::From<QuorumCall> for GovernorPreventLateQuorumCalls {
        fn from(value: QuorumCall) -> Self {
            Self::Quorum(value)
        }
    }
    impl ::core::convert::From<RelayCall> for GovernorPreventLateQuorumCalls {
    ...
    impl ::core::convert::From<StateCall> for GovernorPreventLateQuorumCalls {
    ...
    impl ::core::convert::From<VersionCall> for GovernorPreventLateQuorumCalls {
        fn from(value: VersionCall) -> Self {
            Self::Version(value)
        }
    }
    impl ::core::convert::From<VotingDelayCall> for GovernorPreventLateQuorumCalls {
        fn from(value: VotingDelayCall) -> Self {
            Self::VotingDelay(value)
        }
    }
    impl ::core::convert::From<VotingPeriodCall> for GovernorPreventLateQuorumCalls {
