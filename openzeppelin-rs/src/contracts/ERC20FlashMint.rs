...
pub mod erc20_flash_mint {
    ...
    pub static ERC20FLASHMINT_ABI: ::ethers_contract::Lazy<::ethers_core::abi::Abi> = ::ethers_contract::Lazy::new(||
    ::ethers_core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid"));
    pub struct ERC20FlashMint<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers_providers::Middleware> ERC20FlashMint<M> {
    ...
    impl ::ethers_contract::EthLogDecode for ERC20FlashMintEvents {
        fn decode_log(
    ...
    impl ::ethers_core::abi::AbiDecode for ERC20FlashMintCalls {
        fn decode(
            data: impl AsRef<[u8]>,
            ...
            if let Ok(decoded)
                = <FlashFeeCall as ::ethers_core::abi::AbiDecode>::decode(data) {
                return Ok(Self::FlashFee(decoded));
            }
            if let Ok(decoded)
                = <FlashLoanCall as ::ethers_core::abi::AbiDecode>::decode(data) {
            ...
            if let Ok(decoded)
                = <MaxFlashLoanCall as ::ethers_core::abi::AbiDecode>::decode(data) {
    ...
    impl ::ethers_core::abi::AbiEncode for ERC20FlashMintCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                Self::FlashFee(element) => ::ethers_core::abi::AbiEncode::encode(element),
    ...
    pub struct FlashFeeReturn(pub ::ethers_core::types::U256);
    ...
    pub struct MaxFlashLoanReturn(pub ::ethers_core::types::U256);
