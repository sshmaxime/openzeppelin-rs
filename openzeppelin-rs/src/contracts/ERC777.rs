...
pub mod erc777 {
    ...
    pub static ERC777_ABI: ::ethers_contract::Lazy<::ethers_core::abi::Abi> = ::ethers_contract::Lazy::new(||
    ...
    pub static ERC777_BYTECODE: ::ethers_core::types::Bytes = ::ethers_core::types::Bytes::from_static(
        __BYTECODE,
    );
    #[rustfmt::skip]
    ...
    pub static ERC777_DEPLOYED_BYTECODE: ::ethers_core::types::Bytes = ::ethers_core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    pub struct ERC777<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers_providers::Middleware> ERC777<M> {
        ...
        pub fn events(
            &self,
        ) -> ::ethers_contract::builders::Event<::std::sync::Arc<M>, M, ERC777Events> {
    ...
    impl ::ethers_contract::EthLogDecode for ERC777Events {
        fn decode_log(
    ...
    impl ::ethers_core::abi::AbiDecode for ERC777Calls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers_core::abi::AbiEncode for ERC777Calls {
