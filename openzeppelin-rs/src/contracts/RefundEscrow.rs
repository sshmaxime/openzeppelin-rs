...
pub mod refund_escrow {
    ...
    pub static REFUNDESCROW_ABI: ::ethers_contract::Lazy<::ethers_core::abi::Abi> = ::ethers_contract::Lazy::new(||
    ...
    pub static REFUNDESCROW_BYTECODE: ::ethers_core::types::Bytes = ::ethers_core::types::Bytes::from_static(
        __BYTECODE,
    );
    #[rustfmt::skip]
    ...
    pub static REFUNDESCROW_DEPLOYED_BYTECODE: ::ethers_core::types::Bytes = ::ethers_core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    pub struct RefundEscrow<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers_providers::Middleware> RefundEscrow<M> {
        ...
        pub fn close(&self) -> ::ethers_contract::builders::ContractCall<M, ()> {
            self.0
        ...
        pub fn deposit(
            &self,
            refundee: ::ethers_core::types::Address,
        ) -> ::ethers_contract::builders::ContractCall<M, ()> {
            self.0
    ...
    impl ::ethers_contract::EthLogDecode for RefundEscrowEvents {
        fn decode_log(
    ...
    pub struct DepositCall {
        pub refundee: ::ethers_core::types::Address,
    }
    ...
    pub struct WithdrawalAllowedCall(pub ::ethers_core::types::Address);
    ...
    impl ::ethers_core::abi::AbiDecode for RefundEscrowCalls {
        fn decode(
            data: impl AsRef<[u8]>,
            ...
            if let Ok(decoded)
                = <BeneficiaryWithdrawCall as ::ethers_core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::BeneficiaryWithdraw(decoded));
            }
            if let Ok(decoded)
                = <CloseCall as ::ethers_core::abi::AbiDecode>::decode(data) {
            ...
            if let Ok(decoded)
                = <EnableRefundsCall as ::ethers_core::abi::AbiDecode>::decode(data) {
    ...
    impl ::ethers_core::abi::AbiEncode for RefundEscrowCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                Self::Close(element) => ::ethers_core::abi::AbiEncode::encode(element),
