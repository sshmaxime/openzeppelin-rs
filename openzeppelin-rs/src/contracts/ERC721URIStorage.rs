...
pub mod erc721uri_storage {
    ...
    pub static ERC721URISTORAGE_ABI: ::ethers_contract::Lazy<::ethers_core::abi::Abi> = ::ethers_contract::Lazy::new(||
    ::ethers_core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid"));
    pub struct ERC721URIStorage<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers_providers::Middleware> ERC721URIStorage<M> {
    ...
    impl ::ethers_contract::EthLogDecode for ERC721URIStorageEvents {
        fn decode_log(
    ...
    impl ::ethers_core::abi::AbiDecode for ERC721URIStorageCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers_core::abi::AbiEncode for ERC721URIStorageCalls {
