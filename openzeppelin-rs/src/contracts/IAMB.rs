...
pub mod iamb {
    ...
    pub static IAMB_ABI: ::ethers_contract::Lazy<::ethers_core::abi::Abi> = ::ethers_contract::Lazy::new(||
    ::ethers_core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid"));
    pub struct IAMB<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers_providers::Middleware> IAMB<M> {
        ...
        pub fn events(
            &self,
        ) -> ::ethers_contract::builders::Event<::std::sync::Arc<M>, M, IAMBEvents> {
    ...
    pub struct UserRequestForAffirmationFilter {
        #[ethevent(indexed)]
        pub message_id: [u8; 32],
        pub encoded_data: ::ethers_core::types::Bytes,
    }
    #[derive(
        Clone,
        ::ethers_contract::EthEvent,
    ...
    impl ::ethers_contract::EthLogDecode for IAMBEvents {
        fn decode_log(
    ...
    pub struct RequireToConfirmMessageCall {
        pub contract: ::ethers_core::types::Address,
        pub data: ::ethers_core::types::Bytes,
        pub gas: ::ethers_core::types::U256,
    }
    ...
    impl ::ethers_core::abi::AbiDecode for IAMBCalls {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> ::core::result::Result<Self, ::ethers_core::abi::AbiError> {
            let data = data.as_ref();
            if let Ok(decoded)
                = <DestinationChainIdCall as ::ethers_core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::DestinationChainId(decoded));
            }
            if let Ok(decoded)
                = <FailedMessageDataHashCall as ::ethers_core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::FailedMessageDataHash(decoded));
            }
            if let Ok(decoded)
                = <FailedMessageReceiverCall as ::ethers_core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::FailedMessageReceiver(decoded));
            }
            if let Ok(decoded)
                = <FailedMessageSenderCall as ::ethers_core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::FailedMessageSender(decoded));
            }
            if let Ok(decoded)
                = <MaxGasPerTxCall as ::ethers_core::abi::AbiDecode>::decode(data) {
                return Ok(Self::MaxGasPerTx(decoded));
            }
            if let Ok(decoded)
                = <MessageCallStatusCall as ::ethers_core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::MessageCallStatus(decoded));
            }
            if let Ok(decoded)
                = <MessageIdCall as ::ethers_core::abi::AbiDecode>::decode(data) {
                return Ok(Self::MessageId(decoded));
            }
            if let Ok(decoded)
                = <MessageSenderCall as ::ethers_core::abi::AbiDecode>::decode(data) {
                return Ok(Self::MessageSender(decoded));
            }
            if let Ok(decoded)
                = <MessageSourceChainIdCall as ::ethers_core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::MessageSourceChainId(decoded));
            }
            if let Ok(decoded)
                = <RequireToConfirmMessageCall as ::ethers_core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::RequireToConfirmMessage(decoded));
            }
            if let Ok(decoded)
                = <RequireToPassMessageCall as ::ethers_core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::RequireToPassMessage(decoded));
            }
            if let Ok(decoded)
                = <SourceChainIdCall as ::ethers_core::abi::AbiDecode>::decode(data) {
                return Ok(Self::SourceChainId(decoded));
            }
            if let Ok(decoded)
                = <TransactionHashCall as ::ethers_core::abi::AbiDecode>::decode(data) {
                return Ok(Self::TransactionHash(decoded));
            }
            Err(::ethers_core::abi::Error::InvalidData.into())
        }
    }
    impl ::ethers_core::abi::AbiEncode for IAMBCalls {
    ...
    pub struct DestinationChainIdReturn(pub ::ethers_core::types::U256);
    ...
    pub struct FailedMessageReceiverReturn(pub ::ethers_core::types::Address);
    ...
    pub struct FailedMessageSenderReturn(pub ::ethers_core::types::Address);
    ...
    pub struct MaxGasPerTxReturn(pub ::ethers_core::types::U256);
    ...
    pub struct MessageSenderReturn(pub ::ethers_core::types::Address);
    ...
    pub struct SourceChainIdReturn(pub ::ethers_core::types::U256);
