...
pub mod access_control_default_admin_rules {
    ...
    pub static ACCESSCONTROLDEFAULTADMINRULES_ABI: ::ethers_contract::Lazy<
        ::ethers_core::abi::Abi,
    > = ::ethers_contract::Lazy::new(|| {
        ::ethers_core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid")
    });
    pub struct AccessControlDefaultAdminRules<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers_providers::Middleware> AccessControlDefaultAdminRules<M> {
    ...
    impl ::ethers_contract::EthLogDecode for AccessControlDefaultAdminRulesEvents {
        fn decode_log(
    ...
    impl ::ethers_core::abi::AbiDecode for AccessControlDefaultAdminRulesCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers_core::abi::AbiEncode for AccessControlDefaultAdminRulesCalls {
