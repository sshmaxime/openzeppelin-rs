...
pub mod erc1155_receiver {
    ...
    pub static ERC1155RECEIVER_ABI: ::ethers_contract::Lazy<::ethers_core::abi::Abi> = ::ethers_contract::Lazy::new(||
    ::ethers_core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid"));
    pub struct ERC1155Receiver<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers_providers::Middleware> ERC1155Receiver<M> {
    ...
    impl ::ethers_core::abi::AbiDecode for ERC1155ReceiverCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers_core::abi::AbiEncode for ERC1155ReceiverCalls {
