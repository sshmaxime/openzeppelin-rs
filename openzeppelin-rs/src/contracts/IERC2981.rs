...
pub mod ierc2981 {
    ...
    pub static IERC2981_ABI: ::ethers_contract::Lazy<::ethers_core::abi::Abi> = ::ethers_contract::Lazy::new(||
    ::ethers_core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid"));
    pub struct IERC2981<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers_providers::Middleware> IERC2981<M> {
    ...
    impl ::ethers_core::abi::AbiDecode for IERC2981Calls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers_core::abi::AbiEncode for IERC2981Calls {
    ...
    pub struct RoyaltyInfoReturn {
        ...
        pub royalty_amount: ::ethers_core::types::U256,
    }
