...
pub mod ierc3156_flash_lender {
    ...
    pub static IERC3156FLASHLENDER_ABI: ::ethers_contract::Lazy<
        ::ethers_core::abi::Abi,
    > = ::ethers_contract::Lazy::new(|| {
        ::ethers_core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid")
    });
    pub struct IERC3156FlashLender<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers_providers::Middleware> IERC3156FlashLender<M> {
    ...
    impl ::ethers_core::abi::AbiDecode for IERC3156FlashLenderCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers_core::abi::AbiEncode for IERC3156FlashLenderCalls {
