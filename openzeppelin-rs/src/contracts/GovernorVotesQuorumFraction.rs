...
pub mod governor_votes_quorum_fraction {
    ...
    pub static GOVERNORVOTESQUORUMFRACTION_ABI: ::ethers_contract::Lazy<
        ::ethers_core::abi::Abi,
    > = ::ethers_contract::Lazy::new(|| {
        ::ethers_core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid")
    });
    pub struct GovernorVotesQuorumFraction<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers_providers::Middleware> GovernorVotesQuorumFraction<M> {
        ...
        pub fn update_quorum_numerator(
            &self,
            new_quorum_numerator: ::ethers_core::types::U256,
        ) -> ::ethers_contract::builders::ContractCall<M, ()> {
            self.0
    ...
    impl ::ethers_core::abi::AbiDecode for GovernorVotesQuorumFractionErrors {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers_core::abi::AbiEncode for GovernorVotesQuorumFractionErrors {
    ...
    impl ::ethers_contract::ContractRevert for GovernorVotesQuorumFractionErrors {
    ...
    pub struct QuorumNumeratorUpdatedFilter {
        pub old_quorum_numerator: ::ethers_core::types::U256,
        pub new_quorum_numerator: ::ethers_core::types::U256,
    }
    #[derive(
        Clone,
        ::ethers_contract::EthEvent,
    ...
    impl ::ethers_contract::EthLogDecode for GovernorVotesQuorumFractionEvents {
        fn decode_log(
    ...
    impl ::ethers_core::abi::AbiDecode for GovernorVotesQuorumFractionCalls {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> ::core::result::Result<Self, ::ethers_core::abi::AbiError> {
            let data = data.as_ref();
            ...
            if let Ok(decoded)
                = <QuorumDenominatorCall as ::ethers_core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::QuorumDenominator(decoded));
            }
            if let Ok(decoded)
                = <QuorumNumeratorWithTimepointCall as ::ethers_core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::QuorumNumeratorWithTimepoint(decoded));
            }
            if let Ok(decoded)
                = <QuorumNumeratorCall as ::ethers_core::abi::AbiDecode>::decode(data) {
            ...
            if let Ok(decoded)
                = <UpdateQuorumNumeratorCall as ::ethers_core::abi::AbiDecode>::decode(
                    data,
                ) {
    ...
    impl ::ethers_core::abi::AbiEncode for GovernorVotesQuorumFractionCalls {
    ...
    pub struct QuorumDenominatorReturn(pub ::ethers_core::types::U256);
    ...
    pub struct QuorumNumeratorWithTimepointReturn(pub ::ethers_core::types::U256);
    ...
    pub struct QuorumNumeratorReturn(pub ::ethers_core::types::U256);
