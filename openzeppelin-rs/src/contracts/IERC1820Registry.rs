...
pub mod ierc1820_registry {
    ...
    pub static IERC1820REGISTRY_ABI: ::ethers_contract::Lazy<::ethers_core::abi::Abi> = ::ethers_contract::Lazy::new(||
    ::ethers_core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid"));
    pub struct IERC1820Registry<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers_providers::Middleware> IERC1820Registry<M> {
        ...
        pub fn set_interface_implementer(
            ...
            account: ::ethers_core::types::Address,
            interface_hash: [u8; 32],
            implementer: ::ethers_core::types::Address,
        ...
        pub fn set_manager(
            &self,
            account: ::ethers_core::types::Address,
            new_manager: ::ethers_core::types::Address,
        ) -> ::ethers_contract::builders::ContractCall<M, ()> {
            self.0
    ...
    pub struct InterfaceImplementerSetFilter {
        ...
        #[ethevent(indexed)]
        pub implementer: ::ethers_core::types::Address,
    }
    #[derive(
        Clone,
        ::ethers_contract::EthEvent,
    ...
    pub struct ManagerChangedFilter {
        ...
        pub account: ::ethers_core::types::Address,
        #[ethevent(indexed)]
        pub new_manager: ::ethers_core::types::Address,
    }
    ...
    impl ::ethers_contract::EthLogDecode for IERC1820RegistryEvents {
        fn decode_log(
    ...
    impl ::ethers_core::abi::AbiDecode for IERC1820RegistryCalls {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> ::core::result::Result<Self, ::ethers_core::abi::AbiError> {
            let data = data.as_ref();
            if let Ok(decoded)
                = <GetInterfaceImplementerCall as ::ethers_core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::GetInterfaceImplementer(decoded));
            }
            if let Ok(decoded)
                = <GetManagerCall as ::ethers_core::abi::AbiDecode>::decode(data) {
                return Ok(Self::GetManager(decoded));
            }
            if let Ok(decoded)
                = <ImplementsERC165InterfaceCall as ::ethers_core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::ImplementsERC165Interface(decoded));
            }
            if let Ok(decoded)
                = <ImplementsERC165InterfaceNoCacheCall as ::ethers_core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::ImplementsERC165InterfaceNoCache(decoded));
            }
            if let Ok(decoded)
                = <InterfaceHashCall as ::ethers_core::abi::AbiDecode>::decode(data) {
                return Ok(Self::InterfaceHash(decoded));
            }
            if let Ok(decoded)
                = <SetInterfaceImplementerCall as ::ethers_core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::SetInterfaceImplementer(decoded));
            }
            if let Ok(decoded)
                = <SetManagerCall as ::ethers_core::abi::AbiDecode>::decode(data) {
                return Ok(Self::SetManager(decoded));
            }
            if let Ok(decoded)
                = <UpdateERC165CacheCall as ::ethers_core::abi::AbiDecode>::decode(
                    data,
                ) {
    ...
    impl ::ethers_core::abi::AbiEncode for IERC1820RegistryCalls {
    ...
    pub struct GetInterfaceImplementerReturn(pub ::ethers_core::types::Address);
    ...
    pub struct GetManagerReturn(pub ::ethers_core::types::Address);
