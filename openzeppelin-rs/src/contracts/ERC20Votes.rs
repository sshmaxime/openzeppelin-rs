...
pub mod erc20_votes {
    ...
    pub static ERC20VOTES_ABI: ::ethers_contract::Lazy<::ethers_core::abi::Abi> = ::ethers_contract::Lazy::new(||
    ::ethers_core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid"));
    pub struct ERC20Votes<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers_providers::Middleware> ERC20Votes<M> {
    ...
    impl ::ethers_core::abi::AbiDecode for ERC20VotesErrors {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers_core::abi::AbiEncode for ERC20VotesErrors {
    ...
    impl ::ethers_contract::ContractRevert for ERC20VotesErrors {
    ...
    impl ::ethers_contract::EthLogDecode for ERC20VotesEvents {
        fn decode_log(
    ...
    impl ::ethers_core::abi::AbiDecode for ERC20VotesCalls {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> ::core::result::Result<Self, ::ethers_core::abi::AbiError> {
            let data = data.as_ref();
    ...
    impl ::ethers_core::abi::AbiEncode for ERC20VotesCalls {
