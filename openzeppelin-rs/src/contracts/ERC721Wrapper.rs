...
pub mod erc721_wrapper {
    ...
    pub static ERC721WRAPPER_ABI: ::ethers_contract::Lazy<::ethers_core::abi::Abi> = ::ethers_contract::Lazy::new(||
    ::ethers_core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid"));
    pub struct ERC721Wrapper<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers_providers::Middleware> ERC721Wrapper<M> {
        ...
        pub fn deposit_for(
            ...
            token_ids: ::std::vec::Vec<::ethers_core::types::U256>,
    ...
    impl ::ethers_contract::EthLogDecode for ERC721WrapperEvents {
        fn decode_log(
    ...
    pub struct OnERC721ReceivedCall {
        pub p0: ::ethers_core::types::Address,
        pub from: ::ethers_core::types::Address,
        pub token_id: ::ethers_core::types::U256,
        pub p3: ::ethers_core::types::Bytes,
    }
    ...
    impl ::ethers_core::abi::AbiDecode for ERC721WrapperCalls {
        fn decode(
            data: impl AsRef<[u8]>,
            ...
            if let Ok(decoded)
                = <DepositForCall as ::ethers_core::abi::AbiDecode>::decode(data) {
            ...
            if let Ok(decoded)
                = <UnderlyingCall as ::ethers_core::abi::AbiDecode>::decode(data) {
                return Ok(Self::Underlying(decoded));
            }
            if let Ok(decoded)
                = <WithdrawToCall as ::ethers_core::abi::AbiDecode>::decode(data) {
                return Ok(Self::WithdrawTo(decoded));
            }
            Err(::ethers_core::abi::Error::InvalidData.into())
        }
    }
    impl ::ethers_core::abi::AbiEncode for ERC721WrapperCalls {
    ...
    pub struct UnderlyingReturn(pub ::ethers_core::types::Address);
