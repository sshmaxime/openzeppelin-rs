...
pub mod i_access_control {
    ...
    pub static IACCESSCONTROL_ABI: ::ethers_contract::Lazy<::ethers_core::abi::Abi> = ::ethers_contract::Lazy::new(||
    ::ethers_core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid"));
    pub struct IAccessControl<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers_providers::Middleware> IAccessControl<M> {
    ...
    impl ::ethers_contract::EthLogDecode for IAccessControlEvents {
        fn decode_log(
    ...
    impl ::ethers_core::abi::AbiDecode for IAccessControlCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers_core::abi::AbiEncode for IAccessControlCalls {
