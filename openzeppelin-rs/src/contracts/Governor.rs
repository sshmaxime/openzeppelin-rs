...
pub mod governor {
    ...
    pub static GOVERNOR_ABI: ::ethers_contract::Lazy<::ethers_core::abi::Abi> = ::ethers_contract::Lazy::new(||
    ::ethers_core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid"));
    pub struct Governor<M>(::ethers_contract::Contract<M>);
    ...
    impl<M> ::core::fmt::Debug for Governor<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(Governor)).field(&self.address()).finish()
        }
    }
    impl<M: ::ethers_providers::Middleware> Governor<M> {
        ...
        pub fn events(
            &self,
        ) -> ::ethers_contract::builders::Event<::std::sync::Arc<M>, M, GovernorEvents> {
    ...
    impl ::ethers_core::abi::AbiDecode for GovernorErrors {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers_core::abi::AbiEncode for GovernorErrors {
    ...
    impl ::ethers_contract::ContractRevert for GovernorErrors {
    ...
    impl ::ethers_contract::EthLogDecode for GovernorEvents {
        fn decode_log(
    ...
    impl ::ethers_core::abi::AbiDecode for GovernorCalls {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> ::core::result::Result<Self, ::ethers_core::abi::AbiError> {
            let data = data.as_ref();
    ...
    impl ::ethers_core::abi::AbiEncode for GovernorCalls {
