...
pub mod i_cross_domain_messenger {
    ...
    pub static ICROSSDOMAINMESSENGER_ABI: ::ethers_contract::Lazy<
        ::ethers_core::abi::Abi,
    > = ::ethers_contract::Lazy::new(|| {
        ::ethers_core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid")
    });
    pub struct ICrossDomainMessenger<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers_providers::Middleware> ICrossDomainMessenger<M> {
    ...
    pub struct SentMessageFilter {
        ...
        pub message_nonce: ::ethers_core::types::U256,
    ...
    impl ::ethers_contract::EthLogDecode for ICrossDomainMessengerEvents {
        fn decode_log(
    ...
    impl ::ethers_core::abi::AbiDecode for ICrossDomainMessengerCalls {
        fn decode(
            data: impl AsRef<[u8]>,
            ...
            if let Ok(decoded)
                = <XdomainMessageSenderCall as ::ethers_core::abi::AbiDecode>::decode(
                    data,
                ) {
    ...
    impl ::ethers_core::abi::AbiEncode for ICrossDomainMessengerCalls {
    ...
    pub struct XdomainMessageSenderReturn(pub ::ethers_core::types::Address);
}
