...
pub mod double_ended_queue {
    ...
    pub static DOUBLEENDEDQUEUE_ABI: ::ethers_contract::Lazy<::ethers_core::abi::Abi> = ::ethers_contract::Lazy::new(||
    ...
    pub static DOUBLEENDEDQUEUE_BYTECODE: ::ethers_core::types::Bytes = ::ethers_core::types::Bytes::from_static(
        __BYTECODE,
    );
    #[rustfmt::skip]
    ...
    pub static DOUBLEENDEDQUEUE_DEPLOYED_BYTECODE: ::ethers_core::types::Bytes = ::ethers_core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    pub struct DoubleEndedQueue<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers_providers::Middleware> DoubleEndedQueue<M> {
    ...
    impl ::ethers_core::abi::AbiDecode for DoubleEndedQueueErrors {
        fn decode(
            data: impl AsRef<[u8]>,
            ...
            if let Ok(decoded)
                = <OutOfBounds as ::ethers_core::abi::AbiDecode>::decode(data) {
                return Ok(Self::OutOfBounds(decoded));
            }
            Err(::ethers_core::abi::Error::InvalidData.into())
        }
    }
    impl ::ethers_core::abi::AbiEncode for DoubleEndedQueueErrors {
    ...
    impl ::ethers_contract::ContractRevert for DoubleEndedQueueErrors {
        fn valid_selector(selector: [u8; 4]) -> bool {
            match selector {
                ...
                _ if selector
                    == <OutOfBounds as ::ethers_contract::EthError>::selector() => true,
                _ => false,
            }
        }
    }
