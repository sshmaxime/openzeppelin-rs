...
pub mod erc20_wrapper {
    ...
    pub static ERC20WRAPPER_ABI: ::ethers_contract::Lazy<::ethers_core::abi::Abi> = ::ethers_contract::Lazy::new(||
    ::ethers_core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid"));
    pub struct ERC20Wrapper<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers_providers::Middleware> ERC20Wrapper<M> {
    ...
    impl ::ethers_contract::EthLogDecode for ERC20WrapperEvents {
        fn decode_log(
    ...
    impl ::ethers_core::abi::AbiDecode for ERC20WrapperCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers_core::abi::AbiEncode for ERC20WrapperCalls {
