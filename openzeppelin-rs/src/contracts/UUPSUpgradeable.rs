...
pub mod uups_upgradeable {
    ...
    pub static UUPSUPGRADEABLE_ABI: ::ethers_contract::Lazy<::ethers_core::abi::Abi> = ::ethers_contract::Lazy::new(||
    ::ethers_core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid"));
    pub struct UUPSUpgradeable<M>(::ethers_contract::Contract<M>);
    ...
    impl<M> ::core::fmt::Debug for UUPSUpgradeable<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(UUPSUpgradeable)).field(&self.address()).finish()
        }
    }
    impl<M: ::ethers_providers::Middleware> UUPSUpgradeable<M> {
    ...
    impl ::ethers_contract::EthLogDecode for UUPSUpgradeableEvents {
        fn decode_log(
    ...
    impl ::core::convert::From<AdminChangedFilter> for UUPSUpgradeableEvents {
        fn from(value: AdminChangedFilter) -> Self {
            Self::AdminChangedFilter(value)
        }
    }
    impl ::core::convert::From<BeaconUpgradedFilter> for UUPSUpgradeableEvents {
    ...
    impl ::ethers_core::abi::AbiDecode for UUPSUpgradeableCalls {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> ::core::result::Result<Self, ::ethers_core::abi::AbiError> {
            let data = data.as_ref();
            if let Ok(decoded)
                = <ProxiableUUIDCall as ::ethers_core::abi::AbiDecode>::decode(data) {
    ...
    impl ::ethers_core::abi::AbiEncode for UUPSUpgradeableCalls {
    ...
    impl ::core::convert::From<UpgradeToCall> for UUPSUpgradeableCalls {
