...
pub mod governor_timelock_control {
    ...
    pub static GOVERNORTIMELOCKCONTROL_ABI: ::ethers_contract::Lazy<
        ::ethers_core::abi::Abi,
    > = ::ethers_contract::Lazy::new(|| {
        ::ethers_core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid")
    });
    pub struct GovernorTimelockControl<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers_providers::Middleware> GovernorTimelockControl<M> {
    ...
    pub enum GovernorTimelockControlErrors {
        Empty(Empty),
    ...
    impl ::ethers_core::abi::AbiDecode for GovernorTimelockControlErrors {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers_core::abi::AbiEncode for GovernorTimelockControlErrors {
    ...
    impl ::ethers_contract::ContractRevert for GovernorTimelockControlErrors {
    ...
    impl ::core::fmt::Display for GovernorTimelockControlErrors {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<::std::string::String> for GovernorTimelockControlErrors {
        fn from(value: String) -> Self {
            Self::RevertString(value)
        }
    }
    impl ::core::convert::From<Empty> for GovernorTimelockControlErrors {
        fn from(value: Empty) -> Self {
            Self::Empty(value)
        }
    }
    impl ::core::convert::From<InvalidShortString> for GovernorTimelockControlErrors {
        fn from(value: InvalidShortString) -> Self {
            Self::InvalidShortString(value)
        }
    }
    impl ::core::convert::From<StringTooLong> for GovernorTimelockControlErrors {
    ...
    impl ::ethers_contract::EthLogDecode for GovernorTimelockControlEvents {
        fn decode_log(
            log: &::ethers_core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers_core::abi::Error> {
            if let Ok(decoded) = Eip712DomainChangedFilter::decode_log(log) {
                return Ok(
                    GovernorTimelockControlEvents::Eip712DomainChangedFilter(decoded),
                );
            }
    ...
    impl ::ethers_core::abi::AbiDecode for GovernorTimelockControlCalls {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> ::core::result::Result<Self, ::ethers_core::abi::AbiError> {
            let data = data.as_ref();
    ...
    impl ::ethers_core::abi::AbiEncode for GovernorTimelockControlCalls {
    ...
    impl ::core::convert::From<ClockModeCall> for GovernorTimelockControlCalls {
    ...
    impl ::core::convert::From<CancelCall> for GovernorTimelockControlCalls {
    ...
    impl ::core::convert::From<ClockCall> for GovernorTimelockControlCalls {
        fn from(value: ClockCall) -> Self {
            Self::Clock(value)
        }
    }
    impl ::core::convert::From<Eip712DomainCall> for GovernorTimelockControlCalls {
    ...
    impl ::core::convert::From<ProposalProposerCall> for GovernorTimelockControlCalls {
