...
pub mod erc721_enumerable {
    ...
    pub static ERC721ENUMERABLE_ABI: ::ethers_contract::Lazy<::ethers_core::abi::Abi> = ::ethers_contract::Lazy::new(||
    ::ethers_core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid"));
    pub struct ERC721Enumerable<M>(::ethers_contract::Contract<M>);
    ...
    impl<M> ::core::fmt::Debug for ERC721Enumerable<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(ERC721Enumerable)).field(&self.address()).finish()
        }
    }
    impl<M: ::ethers_providers::Middleware> ERC721Enumerable<M> {
    ...
    impl ::ethers_contract::EthLogDecode for ERC721EnumerableEvents {
        fn decode_log(
    ...
    impl ::ethers_core::abi::AbiDecode for ERC721EnumerableCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers_core::abi::AbiEncode for ERC721EnumerableCalls {
