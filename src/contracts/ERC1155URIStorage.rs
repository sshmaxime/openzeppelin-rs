...
pub mod erc1155uri_storage {
    ...
    pub static ERC1155URISTORAGE_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    > = ::ethers::contract::Lazy::new(|| {
        ::ethers::core::utils::__serde_json::from_str(__ABI)
            .expect("ABI is always valid")
    });
    pub struct ERC1155URIStorage<M>(::ethers::contract::Contract<M>);
    ...
    impl<M: ::ethers::providers::Middleware> ERC1155URIStorage<M> {
    ...
    impl ::ethers::contract::EthLogDecode for ERC1155URIStorageEvents {
        fn decode_log(
    ...
    impl ::ethers::core::abi::AbiDecode for ERC1155URIStorageCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for ERC1155URIStorageCalls {
