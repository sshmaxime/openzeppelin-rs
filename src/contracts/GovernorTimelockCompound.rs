...
pub mod governor_timelock_compound {
    ...
    pub static GOVERNORTIMELOCKCOMPOUND_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    > = ::ethers::contract::Lazy::new(|| {
        ::ethers::core::utils::__serde_json::from_str(__ABI)
            .expect("ABI is always valid")
    });
    pub struct GovernorTimelockCompound<M>(::ethers::contract::Contract<M>);
    ...
    impl<M: ::ethers::providers::Middleware> GovernorTimelockCompound<M> {
    ...
    impl ::ethers::core::abi::AbiDecode for GovernorTimelockCompoundErrors {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for GovernorTimelockCompoundErrors {
    ...
    impl ::ethers::contract::ContractRevert for GovernorTimelockCompoundErrors {
    ...
    impl ::ethers::contract::EthLogDecode for GovernorTimelockCompoundEvents {
        fn decode_log(
    ...
    impl ::ethers::core::abi::AbiDecode for GovernorTimelockCompoundCalls {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::AbiError> {
            let data = data.as_ref();
    ...
    impl ::ethers::core::abi::AbiEncode for GovernorTimelockCompoundCalls {
