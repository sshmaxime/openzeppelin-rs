...
pub mod ierc1363 {
    ...
    impl ::ethers::core::abi::AbiDecode for IERC1363Calls {
        fn decode(
            ...
            if let Ok(decoded)
                = <ApproveAndCallWithSpenderAndAmountCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
            ...
            if let Ok(decoded)
                = <TransferAndCallWithToAndAmountCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
            ...
            if let Ok(decoded)
                = <TransferFromAndCallWithFromAndToAndDataCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::TransferFromAndCallWithFromAndToAndData(decoded));
            }
            if let Ok(decoded)
                = <TransferFromAndCallCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
