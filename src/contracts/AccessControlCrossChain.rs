...
pub mod access_control_cross_chain {
    ...
    pub static ACCESSCONTROLCROSSCHAIN_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    > = ::ethers::contract::Lazy::new(|| {
        ::ethers::core::utils::__serde_json::from_str(__ABI)
            .expect("ABI is always valid")
    });
    pub struct AccessControlCrossChain<M>(::ethers::contract::Contract<M>);
    ...
    impl<M: ::ethers::providers::Middleware> AccessControlCrossChain<M> {
    ...
    impl ::ethers::contract::EthLogDecode for AccessControlCrossChainEvents {
        fn decode_log(
    ...
    impl ::ethers::core::abi::AbiDecode for AccessControlCrossChainCalls {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::AbiError> {
            let data = data.as_ref();
            if let Ok(decoded)
                = <CrosschainAliasCall as ::ethers::core::abi::AbiDecode>::decode(data) {
    ...
    impl ::ethers::core::abi::AbiEncode for AccessControlCrossChainCalls {
