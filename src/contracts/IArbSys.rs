...
pub mod i_arb_sys {
    ...
    impl<M: ::ethers::providers::Middleware> IArbSys<M> {
        ...
        pub fn arb_block_hash(
            &self,
            arb_block_num: ::ethers::core::types::U256,
        ...
        pub fn map_l1_sender_contract_address_to_l2_alias(
            ...
            unused: ::ethers::core::types::Address,
        ...
        pub fn send_merkle_tree_state(
            ...
            M,
            (::ethers::core::types::U256, [u8; 32], ::std::vec::Vec<[u8; 32]>),
        > {
            self.0
        ...
        pub fn events(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, IArbSysEvents> {
    ...
    pub struct L2ToL1TransactionFilter {
        ...
        #[ethevent(indexed)]
        pub unique_id: ::ethers::core::types::U256,
        #[ethevent(indexed)]
        pub batch_number: ::ethers::core::types::U256,
        pub index_in_batch: ::ethers::core::types::U256,
        pub arb_block_num: ::ethers::core::types::U256,
        pub eth_block_num: ::ethers::core::types::U256,
        pub timestamp: ::ethers::core::types::U256,
        pub callvalue: ::ethers::core::types::U256,
    ...
    pub struct L2ToL1TxFilter {
        ...
        pub destination: ::ethers::core::types::Address,
        #[ethevent(indexed)]
        pub hash: ::ethers::core::types::U256,
        #[ethevent(indexed)]
    ...
    pub struct SendMerkleUpdateFilter {
        #[ethevent(indexed)]
        pub reserved: ::ethers::core::types::U256,
        #[ethevent(indexed)]
        pub hash: [u8; 32],
        #[ethevent(indexed)]
        pub position: ::ethers::core::types::U256,
    ...
    impl ::ethers::contract::EthLogDecode for IArbSysEvents {
        fn decode_log(
    ...
    pub struct MapL1SenderContractAddressToL2AliasCall {
        ...
        pub unused: ::ethers::core::types::Address,
    }
    ...
    impl ::ethers::core::abi::AbiDecode for IArbSysCalls {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::AbiError> {
            let data = data.as_ref();
            if let Ok(decoded)
                = <ArbBlockHashCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::ArbBlockHash(decoded));
            }
            if let Ok(decoded)
                = <ArbBlockNumberCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::ArbBlockNumber(decoded));
            }
            if let Ok(decoded)
                = <ArbChainIDCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::ArbChainID(decoded));
            }
            if let Ok(decoded)
                = <ArbOSVersionCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::ArbOSVersion(decoded));
            }
            if let Ok(decoded)
                = <GetStorageGasAvailableCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::GetStorageGasAvailable(decoded));
            }
            if let Ok(decoded)
                = <IsTopLevelCallCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::IsTopLevelCall(decoded));
            }
            if let Ok(decoded)
                = <MapL1SenderContractAddressToL2AliasCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::MapL1SenderContractAddressToL2Alias(decoded));
            }
            if let Ok(decoded)
                = <MyCallersAddressWithoutAliasingCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::MyCallersAddressWithoutAliasing(decoded));
            }
            if let Ok(decoded)
                = <SendMerkleTreeStateCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::SendMerkleTreeState(decoded));
            }
            if let Ok(decoded)
                = <SendTxToL1Call as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::SendTxToL1(decoded));
            }
            if let Ok(decoded)
                = <WasMyCallersAddressAliasedCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
    ...
    impl ::ethers::core::abi::AbiEncode for IArbSysCalls {
    ...
    pub struct ArbChainIDReturn(pub ::ethers::core::types::U256);
    ...
    pub struct ArbOSVersionReturn(pub ::ethers::core::types::U256);
    ...
    pub struct GetStorageGasAvailableReturn(pub ::ethers::core::types::U256);
    ...
    pub struct MyCallersAddressWithoutAliasingReturn(pub ::ethers::core::types::Address);
    ...
    pub struct SendTxToL1Return(pub ::ethers::core::types::U256);
    ...
    pub struct WithdrawEthReturn(pub ::ethers::core::types::U256);
}
