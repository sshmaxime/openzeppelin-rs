...
pub mod cross_chain_enabled_amb {
    ...
    pub static CROSSCHAINENABLEDAMB_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    ...
    pub static CROSSCHAINENABLEDAMB_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __BYTECODE,
    );
    #[rustfmt::skip]
    ...
    pub static CROSSCHAINENABLEDAMB_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    pub struct CrossChainEnabledAMB<M>(::ethers::contract::Contract<M>);
    ...
    impl<M: ::ethers::providers::Middleware> CrossChainEnabledAMB<M> {
