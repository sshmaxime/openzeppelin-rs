...
pub mod ierc2309 {
    ...
    pub static IERC2309_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(||
    ::ethers::core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid"));
    pub struct IERC2309<M>(::ethers::contract::Contract<M>);
    ...
    impl<M: ::ethers::providers::Middleware> IERC2309<M> {
