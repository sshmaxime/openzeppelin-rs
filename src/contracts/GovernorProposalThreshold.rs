...
pub mod governor_proposal_threshold {
    ...
    pub static GOVERNORPROPOSALTHRESHOLD_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    > = ::ethers::contract::Lazy::new(|| {
        ::ethers::core::utils::__serde_json::from_str(__ABI)
            .expect("ABI is always valid")
    });
    pub struct GovernorProposalThreshold<M>(::ethers::contract::Contract<M>);
    ...
    impl<M: ::ethers::providers::Middleware> GovernorProposalThreshold<M> {
    ...
    impl ::ethers::core::abi::AbiDecode for GovernorProposalThresholdErrors {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for GovernorProposalThresholdErrors {
    ...
    impl ::ethers::contract::ContractRevert for GovernorProposalThresholdErrors {
    ...
    impl ::ethers::contract::EthLogDecode for GovernorProposalThresholdEvents {
        fn decode_log(
    ...
    impl ::ethers::core::abi::AbiDecode for GovernorProposalThresholdCalls {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::AbiError> {
            let data = data.as_ref();
    ...
    impl ::ethers::core::abi::AbiEncode for GovernorProposalThresholdCalls {
