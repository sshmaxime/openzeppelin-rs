...
pub mod cross_chain_enabled_optimism {
    ...
    pub static CROSSCHAINENABLEDOPTIMISM_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    > = ::ethers::contract::Lazy::new(|| {
        ::ethers::core::utils::__serde_json::from_str(__ABI)
            .expect("ABI is always valid")
    });
    pub struct CrossChainEnabledOptimism<M>(::ethers::contract::Contract<M>);
    ...
    impl<M: ::ethers::providers::Middleware> CrossChainEnabledOptimism<M> {
