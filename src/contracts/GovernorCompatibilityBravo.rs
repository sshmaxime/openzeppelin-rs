...
pub mod governor_compatibility_bravo {
    ...
    pub static GOVERNORCOMPATIBILITYBRAVO_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    > = ::ethers::contract::Lazy::new(|| {
        ::ethers::core::utils::__serde_json::from_str(__ABI)
            .expect("ABI is always valid")
    });
    pub struct GovernorCompatibilityBravo<M>(::ethers::contract::Contract<M>);
    ...
    impl<M: ::ethers::providers::Middleware> GovernorCompatibilityBravo<M> {
    ...
    impl ::ethers::core::abi::AbiDecode for GovernorCompatibilityBravoErrors {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for GovernorCompatibilityBravoErrors {
    ...
    impl ::ethers::contract::ContractRevert for GovernorCompatibilityBravoErrors {
    ...
    impl ::ethers::contract::EthLogDecode for GovernorCompatibilityBravoEvents {
        fn decode_log(
    ...
    impl ::ethers::core::abi::AbiDecode for GovernorCompatibilityBravoCalls {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::AbiError> {
            let data = data.as_ref();
            ...
            if let Ok(decoded)
                = <QueueWithTargetsCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
    ...
    impl ::ethers::core::abi::AbiEncode for GovernorCompatibilityBravoCalls {
    ...
    pub struct CancelWithTargetsReturn(pub ::ethers::core::types::U256);
    ...
    pub struct ExecuteWithTargetsReturn(pub ::ethers::core::types::U256);
