...
pub mod conditional_escrow {
    ...
    pub static CONDITIONALESCROW_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    > = ::ethers::contract::Lazy::new(|| {
        ::ethers::core::utils::__serde_json::from_str(__ABI)
            .expect("ABI is always valid")
    });
    pub struct ConditionalEscrow<M>(::ethers::contract::Contract<M>);
    ...
    impl<M: ::ethers::providers::Middleware> ConditionalEscrow<M> {
    ...
    impl ::ethers::contract::EthLogDecode for ConditionalEscrowEvents {
        fn decode_log(
    ...
    impl ::ethers::core::abi::AbiDecode for ConditionalEscrowCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for ConditionalEscrowCalls {
