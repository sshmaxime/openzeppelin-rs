...
pub mod erc777_preset_fixed_supply {
    ...
    pub static ERC777PRESETFIXEDSUPPLY_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    ...
    pub static ERC777PRESETFIXEDSUPPLY_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __BYTECODE,
    );
    #[rustfmt::skip]
    ...
    pub static ERC777PRESETFIXEDSUPPLY_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    pub struct ERC777PresetFixedSupply<M>(::ethers::contract::Contract<M>);
    ...
    impl<M: ::ethers::providers::Middleware> ERC777PresetFixedSupply<M> {
    ...
    impl ::ethers::contract::EthLogDecode for ERC777PresetFixedSupplyEvents {
        fn decode_log(
    ...
    impl ::ethers::core::abi::AbiDecode for ERC777PresetFixedSupplyCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for ERC777PresetFixedSupplyCalls {
