...
pub mod i_inbox {
    ...
    pub static IINBOX_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(||
    ::ethers::core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid"));
    pub struct IInbox<M>(::ethers::contract::Contract<M>);
    ...
    impl<M: ::ethers::providers::Middleware> IInbox<M> {
        ...
        pub fn create_retryable_ticket(
            ...
            l_2_call_value: ::ethers::core::types::U256,
            max_submission_cost: ::ethers::core::types::U256,
            excess_fee_refund_address: ::ethers::core::types::Address,
            call_value_refund_address: ::ethers::core::types::Address,
        ...
        pub fn send_l2_message(
            &self,
            message_data: ::ethers::core::types::Bytes,
        ) -> ::ethers::contract::builders::ContractCall<M, ::ethers::core::types::U256> {
            self.0
        ...
        pub fn events(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, IInboxEvents> {
    ...
    pub struct InboxMessageDeliveredFilter {
        #[ethevent(indexed)]
        pub message_num: ::ethers::core::types::U256,
    ...
    impl ::ethers::contract::EthLogDecode for IInboxEvents {
        fn decode_log(
    ...
    pub struct CreateRetryableTicketCall {
        ...
        pub l_2_call_value: ::ethers::core::types::U256,
        pub max_submission_cost: ::ethers::core::types::U256,
        pub excess_fee_refund_address: ::ethers::core::types::Address,
        pub call_value_refund_address: ::ethers::core::types::Address,
    ...
    pub struct SendL2MessageCall {
        pub message_data: ::ethers::core::types::Bytes,
    }
    ...
    impl ::ethers::core::abi::AbiDecode for IInboxCalls {
        fn decode(
            data: impl AsRef<[u8]>,
            ...
            if let Ok(decoded)
                = <CalculateRetryableSubmissionFeeCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::CalculateRetryableSubmissionFee(decoded));
            }
            if let Ok(decoded)
                = <CreateRetryableTicketCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::CreateRetryableTicket(decoded));
            }
            if let Ok(decoded)
                = <DepositEthCall as ::ethers::core::abi::AbiDecode>::decode(data) {
            ...
            if let Ok(decoded)
                = <PostUpgradeInitCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::PostUpgradeInit(decoded));
            }
            if let Ok(decoded)
                = <SendContractTransactionCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::SendContractTransaction(decoded));
            }
            if let Ok(decoded)
                = <SendL1FundedContractTransactionCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::SendL1FundedContractTransaction(decoded));
            }
            if let Ok(decoded)
                = <SendL1FundedUnsignedTransactionCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::SendL1FundedUnsignedTransaction(decoded));
            }
            if let Ok(decoded)
                = <SendL2MessageCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::SendL2Message(decoded));
            }
            if let Ok(decoded)
                = <SendL2MessageFromOriginCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::SendL2MessageFromOrigin(decoded));
            }
            if let Ok(decoded)
                = <SendUnsignedTransactionCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
            ...
            if let Ok(decoded)
                = <UnsafeCreateRetryableTicketCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
    ...
    impl ::ethers::core::abi::AbiEncode for IInboxCalls {
    ...
    pub struct CalculateRetryableSubmissionFeeReturn(pub ::ethers::core::types::U256);
    ...
    pub struct CreateRetryableTicketReturn(pub ::ethers::core::types::U256);
    ...
    pub struct DepositEthReturn(pub ::ethers::core::types::U256);
    ...
    pub struct SendContractTransactionReturn(pub ::ethers::core::types::U256);
    ...
    pub struct SendL1FundedContractTransactionReturn(pub ::ethers::core::types::U256);
    ...
    pub struct SendL1FundedUnsignedTransactionReturn(pub ::ethers::core::types::U256);
    ...
    pub struct SendL2MessageReturn(pub ::ethers::core::types::U256);
    ...
    pub struct SendL2MessageFromOriginReturn(pub ::ethers::core::types::U256);
    ...
    pub struct SendUnsignedTransactionReturn(pub ::ethers::core::types::U256);
    ...
    pub struct UnsafeCreateRetryableTicketReturn(pub ::ethers::core::types::U256);
}
