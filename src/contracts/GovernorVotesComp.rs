...
pub mod governor_votes_comp {
    ...
    pub static GOVERNORVOTESCOMP_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    > = ::ethers::contract::Lazy::new(|| {
        ::ethers::core::utils::__serde_json::from_str(__ABI)
            .expect("ABI is always valid")
    });
    pub struct GovernorVotesComp<M>(::ethers::contract::Contract<M>);
    ...
    impl<M: ::ethers::providers::Middleware> GovernorVotesComp<M> {
    ...
    impl ::ethers::core::abi::AbiDecode for GovernorVotesCompErrors {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for GovernorVotesCompErrors {
    ...
    impl ::ethers::contract::ContractRevert for GovernorVotesCompErrors {
    ...
    impl ::ethers::contract::EthLogDecode for GovernorVotesCompEvents {
        fn decode_log(
    ...
    impl ::ethers::core::abi::AbiDecode for GovernorVotesCompCalls {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::AbiError> {
            let data = data.as_ref();
    ...
    impl ::ethers::core::abi::AbiEncode for GovernorVotesCompCalls {
