...
pub mod i_compound_timelock {
    ...
    pub static ICOMPOUNDTIMELOCK_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    > = ::ethers::contract::Lazy::new(|| {
        ::ethers::core::utils::__serde_json::from_str(__ABI)
            .expect("ABI is always valid")
    });
    pub struct ICompoundTimelock<M>(::ethers::contract::Contract<M>);
    ...
    impl<M: ::ethers::providers::Middleware> ICompoundTimelock<M> {
    ...
    impl ::ethers::contract::EthLogDecode for ICompoundTimelockEvents {
        fn decode_log(
    ...
    pub struct SetDelayCall(pub ::ethers::core::types::U256);
    ...
    pub struct SetPendingAdminCall(pub ::ethers::core::types::Address);
    ...
    impl ::ethers::core::abi::AbiDecode for ICompoundTimelockCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for ICompoundTimelockCalls {
