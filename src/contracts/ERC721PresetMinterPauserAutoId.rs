...
pub mod erc721_preset_minter_pauser_auto_id {
    ...
    pub static ERC721PRESETMINTERPAUSERAUTOID_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    ...
    pub static ERC721PRESETMINTERPAUSERAUTOID_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __BYTECODE,
    );
    #[rustfmt::skip]
    ...
    pub static ERC721PRESETMINTERPAUSERAUTOID_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    pub struct ERC721PresetMinterPauserAutoId<M>(::ethers::contract::Contract<M>);
    ...
    impl<M: ::ethers::providers::Middleware> ERC721PresetMinterPauserAutoId<M> {
    ...
    impl ::ethers::contract::EthLogDecode for ERC721PresetMinterPauserAutoIdEvents {
        fn decode_log(
    ...
    impl ::ethers::core::abi::AbiDecode for ERC721PresetMinterPauserAutoIdCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for ERC721PresetMinterPauserAutoIdCalls {
